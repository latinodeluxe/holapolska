  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <p className="text-gray-500 text-lg mb-12">Residencia, visas, derechos laborales, contratos, urzedy, ZUS, NFZ, inspeccion de trabajo, denuncias y multas.</p>
        <div className="bg-white rounded-2xl p-8 shadow-sm mb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-2">Proximamente</h2>
          <p className="text-gray-500">Estamos preparando guias claras sobre tramites y derechos legales en Polonia.</p>
        </div>
        <div className="bg-white rounded-2xl p-8 shadow-sm">
          <h2 className="text-xl font-bold text-gray-900 mb-2">Importante</h2>
          <p className="text-gray-500">Este contenido es informativo y no sustituye asesoria legal profesional.</p>
        </div>
      </div>
    </main>
  )
