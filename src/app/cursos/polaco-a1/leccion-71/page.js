...
export default function Leccion71() {
  ...
  const vocabulario = [
    { polaco: 'praca', pronunciacion: 'PRA-tsa', traduccion: 'trabajo empleo', ejemplo: 'Mam dobra prace w centrum.' },
    { polaco: 'biuro', pronunciacion: 'BYU-ro', traduccion: 'oficina', ejemplo: 'Pracuje w biurze od osmej.' },
    { polaco: 'szef', pronunciacion: 'shef', traduccion: 'jefe', ejemplo: 'Moj szef jest bardzo wymagajacy.' },
    { polaco: 'kolega z pracy', pronunciacion: 'ko-LE-ga z PRA-tsi', traduccion: 'companero de trabajo', ejemplo: 'Moi koledzy z pracy sa mili.' },
    { polaco: 'spotkanie', pronunciacion: 'spot-KA-nye', traduccion: 'reunion junta', ejemplo: 'Mam spotkanie o dziesiатej.' },
    { polaco: 'projekt', pronunciacion: 'PRO-yekt', traduccion: 'proyecto', ejemplo: 'Pracujemy nad nowym projektem.' },
    { polaco: 'termin', pronunciacion: 'TER-min', traduccion: 'plazo fecha limite', ejemplo: 'Termin oddania to piatek.' },
    { polaco: 'wynagrodzenie', pronunciacion: 'vi-na-gro-DZE-nye', traduccion: 'salario sueldo', ejemplo: 'Negocjuje wynagrodzenie.' },
  ]
  const ejercicios = [
    ...
    { pregunta: 'Como se dice jefe en polaco?', opciones: ['kolega', 'termin', 'szef', 'biuro'], correcta: 'szef' },
    { pregunta: 'Que significa termin?', opciones: ['reunion', 'proyecto', 'plazo fecha limite', 'trabajo'], correcta: 'plazo fecha limite' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 71 · Modulo 8</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">El trabajo y la oficina</h1>
          <p className="text-gray-500 mt-2">Aprende vocabulario del trabajo en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-72" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
