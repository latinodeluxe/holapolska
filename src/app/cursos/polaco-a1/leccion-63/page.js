...
export default function Leccion63() {
  ...
  const vocabulario = [
    { polaco: 'lekarz', pronunciacion: 'LE-kazh', traduccion: 'medico doctor', ejemplo: 'Musze pojsc do lekarza.' },
    { polaco: 'przychodnia', pronunciacion: 'pshi-HOD-nya', traduccion: 'clinica consultorio', ejemplo: 'Przychodnia jest czynna od osmej.' },
    { polaco: 'wizyta', pronunciacion: 'VI-zi-ta', traduccion: 'consulta visita', ejemplo: 'Mam wizyte u lekarza o dziesiatej.' },
    { polaco: 'recepta', pronunciacion: 're-TSEP-ta', traduccion: 'receta medica', ejemplo: 'Lekarz wypisal recepte.' },
    { polaco: 'badanie', pronunciacion: 'ba-DA-nye', traduccion: 'examen analisis', ejemplo: 'Musze zrobic badania krwi.' },
    { polaco: 'Co pana boli?', pronunciacion: 'tso PA-na BO-li', traduccion: 'Que le duele a usted?', ejemplo: 'Co pana boli? Boli mnie gardlo.' },
    { polaco: 'Od kiedy?', pronunciacion: 'od KYE-di', traduccion: 'Desde cuando?', ejemplo: 'Od kiedy ma pan te dolegliwosci?' },
    { polaco: 'skierowanie', pronunciacion: 'skye-ro-VA-nye', traduccion: 'derivacion orden medica', ejemplo: 'Dostalam skierowanie do specjalisty.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice medico en polaco?', opciones: ['przychodnia', 'lekarz', 'wizyta', 'recepta'], correcta: 'lekarz' },
    { pregunta: 'Que significa recepta?', opciones: ['consulta', 'analisis', 'receta medica', 'derivacion'], correcta: 'receta medica' },
    { pregunta: 'Como se dice consulta en polaco?', opciones: ['badanie', 'skierowanie', 'wizyta', 'recepta'], correcta: 'wizyta' },
    { pregunta: 'Que significa badanie?', opciones: ['receta', 'examen analisis', 'consulta', 'derivacion'], correcta: 'examen analisis' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 63 · Modulo 7</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">En el medico</h1>
          <p className="text-gray-500 mt-2">Aprende a comunicarte en el consultorio medico</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-64" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
