...
export default function Leccion78() {
  ...
  const vocabulario = [
    { polaco: 'pensja', pronunciacion: 'PEN-sya', traduccion: 'sueldo mensual', ejemplo: 'Moja pensja wynosi 5000 zlotych.' },
    { polaco: 'premia', pronunciacion: 'PRE-mya', traduccion: 'bono bonificacion', ejemplo: 'Dostalam premie roczna.' },
    { polaco: 'podwyzka', pronunciacion: 'pod-VIZ-ka', traduccion: 'aumento de sueldo', ejemplo: 'Prosze o podwyzke wynagrodzenia.' },
    { polaco: 'benefity', pronunciacion: 'be-ne-FI-ti', traduccion: 'beneficios', ejemplo: 'Firma oferuje swietne benefity.' },
    { polaco: 'karta sportowa', pronunciacion: 'KAR-ta spor-TO-va', traduccion: 'tarjeta deportiva', ejemplo: 'Mam karte sportowa od firmy.' },
    { polaco: 'ubezpieczenie zdrowotne', pronunciacion: 'u-bez-pye-CHE-nye zdro-VOT-ne', traduccion: 'seguro medico', ejemplo: 'Firma zapewnia ubezpieczenie zdrowotne.' },
    { polaco: 'praca zdalna', pronunciacion: 'PRA-tsa ZDAL-na', traduccion: 'teletrabajo', ejemplo: 'Moge pracowac zdalnie dwa dni w tygodniu.' },
    { polaco: 'rozwoj zawodowy', pronunciacion: 'ROZ-vuy za-vo-DO-vi', traduccion: 'desarrollo profesional', ejemplo: 'Firma inwestuje w rozwoj zawodowy pracownikow.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice sueldo en polaco?', opciones: ['premia', 'pensja', 'podwyzka', 'benefity'], correcta: 'pensja' },
    { pregunta: 'Que significa premia?', opciones: ['sueldo', 'bono bonificacion', 'aumento', 'beneficios'], correcta: 'bono bonificacion' },
    { pregunta: 'Como se dice aumento de sueldo en polaco?', opciones: ['pensja', 'benefity', 'podwyzka', 'premia'], correcta: 'podwyzka' },
    { pregunta: 'Que significa benefity?', opciones: ['sueldo', 'bono', 'aumento', 'beneficios'], correcta: 'beneficios' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 78 · Modulo 8</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Salario y beneficios</h1>
          <p className="text-gray-500 mt-2">Aprende vocabulario de compensacion laboral en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-79" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
