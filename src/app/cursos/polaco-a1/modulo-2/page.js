export default function Modulo2() {
  const lecciones = [
    { num: 11, titulo: 'La familia' },
    { num: 12, titulo: 'Mas miembros de la familia' },
    { num: 13, titulo: 'Profesiones' },
    { num: 14, titulo: 'Paises y nacionalidades' },
    { num: 15, titulo: 'Los colores' },
    { num: 16, titulo: 'Objetos del hogar' },
    { num: 17, titulo: 'La casa y las habitaciones' },
    { num: 18, titulo: 'Comida basica' },
    { num: 19, titulo: 'Nacionalidades e idiomas' },
    { num: 20, titulo: 'Repaso del Modulo 2' },
  ]
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Modulo 2</span>
          <h1 className="text-4xl font-bold text-gray-900 mt-1">Familia y profesiones</h1>
          <p className="text-gray-500 mt-2">10 lecciones · Lecciones 11 a 20</p>
        </div>
