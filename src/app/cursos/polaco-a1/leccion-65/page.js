...
export default function Leccion65() {
  ...
  const vocabulario = [
    { polaco: 'zdrowie', pronunciacion: 'ZDRO-vye', traduccion: 'salud', ejemplo: 'Zdrowie jest najwazniejsze.' },
    { polaco: 'zdrowy', pronunciacion: 'ZDRO-vi', traduccion: 'sano saludable', ejemplo: 'Staram sie jesc zdrowo.' },
    { polaco: 'cwiczenia', pronunciacion: 'chvi-CHE-nya', traduccion: 'ejercicios entrenamiento', ejemplo: 'Robie cwiczenia trzy razy w tygodniu.' },
    { polaco: 'biegac', pronunciacion: 'BYE-gach', traduccion: 'correr', ejemplo: 'Biega codziennie rano.' },
    { polaco: 'plywac', pronunciacion: 'PWI-vach', traduccion: 'nadar', ejemplo: 'Lubie plywac w basenie.' },
    { polaco: 'dieta', pronunciacion: 'DYE-ta', traduccion: 'dieta', ejemplo: 'Jestem na diecie bez cukru.' },
    { polaco: 'witaminy', pronunciacion: 'vi-ta-MI-ni', traduccion: 'vitaminas', ejemplo: 'Biore witaminy C i D.' },
    { polaco: 'odpoczynek', pronunciacion: 'od-po-CHI-nek', traduccion: 'descanso reposo', ejemplo: 'Potrzebuje odpoczynku po pracy.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice salud en polaco?', opciones: ['zdrowy', 'zdrowie', 'dieta', 'cwiczenia'], correcta: 'zdrowie' },
    { pregunta: 'Que significa biegac?', opciones: ['nadar', 'correr', 'caminar', 'descansar'], correcta: 'correr' },
    { pregunta: 'Como se dice nadar en polaco?', opciones: ['biegac', 'cwiczenia', 'plywac', 'odpoczynek'], correcta: 'plywac' },
    { pregunta: 'Que significa odpoczynek?', opciones: ['ejercicio', 'vitaminas', 'dieta', 'descanso reposo'], correcta: 'descanso reposo' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 65 · Modulo 7</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Habitos saludables</h1>
          <p className="text-gray-500 mt-2">Aprende vocabulario de salud y bienestar en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-66" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
