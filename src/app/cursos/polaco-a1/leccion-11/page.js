...
export default function Leccion11() {
  ...
  const vocabulario = [
    { polaco: 'rodzina', pronunciacion: 'ro-DZI-na', traduccion: 'familia', ejemplo: 'Mam duza rodzine.' },
    { polaco: 'mama', pronunciacion: 'MA-ma', traduccion: 'mama', ejemplo: 'Moja mama ma na imie Ana.' },
    { polaco: 'tata', pronunciacion: 'TA-ta', traduccion: 'papa', ejemplo: 'Moj tata jest lekarzem.' },
    { polaco: 'brat', pronunciacion: 'brat', traduccion: 'hermano', ejemplo: 'Mam jednego brata.' },
    { polaco: 'siostra', pronunciacion: 'SHYO-stra', traduccion: 'hermana', ejemplo: 'Moja siostra ma dwadziescia lat.' },
    { polaco: 'dziadek', pronunciacion: 'DZHA-dek', traduccion: 'abuelo', ejemplo: 'Moj dziadek ma osiemdziesiat lat.' },
    { polaco: 'babcia', pronunciacion: 'BAB-cha', traduccion: 'abuela', ejemplo: 'Moja babcia gotuje swietnie.' },
    { polaco: 'syn', pronunciacion: 'sin', traduccion: 'hijo', ejemplo: 'Mam jednego syna.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice familia en polaco?', opciones: ['mama', 'rodzina', 'brat', 'siostra'], correcta: 'rodzina' },
    { pregunta: 'Que significa siostra?', opciones: ['hermano', 'hermana', 'mama', 'abuela'], correcta: 'hermana' },
    { pregunta: 'Como se dice abuelo en polaco?', opciones: ['babcia', 'dziadek', 'tata', 'syn'], correcta: 'dziadek' },
    { pregunta: 'Que significa syn?', opciones: ['papa', 'abuelo', 'hijo', 'hermano'], correcta: 'hijo' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 11 · Modulo 2</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">La familia</h1>
          <p className="text-gray-500 mt-2">Aprende los miembros de la familia en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-12" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
