...
export default function Leccion53() {
  ...
  const vocabulario = [
    { polaco: 'ulica', pronunciacion: 'U-li-tsa', traduccion: 'calle', ejemplo: 'Mieszkam przy ulicy Kwiatowej.' },
    { polaco: 'skrzyzowanie', pronunciacion: 'skshi-zho-VA-nye', traduccion: 'cruce interseccion', ejemplo: 'Skrzep na skrzyzowaniu.' },
    { polaco: 'na wprost', pronunciacion: 'na vprost', traduccion: 'recto derecho', ejemplo: 'Prosto na wprost przez sto metrow.' },
    { polaco: 'w lewo', pronunciacion: 'v LE-vo', traduccion: 'a la izquierda', ejemplo: 'Skrecic w lewo na skrzyzowaniu.' },
    { polaco: 'w prawo', pronunciacion: 'v PRA-vo', traduccion: 'a la derecha', ejemplo: 'Skrecic w prawo przy kosciele.' },
    { polaco: 'Jak dojsc do...?', pronunciacion: 'yak DOYSHCH do', traduccion: 'Como llego a...?', ejemplo: 'Jak dojsc do dworca?' },
    { polaco: 'daleko', pronunciacion: 'da-LE-ko', traduccion: 'lejos', ejemplo: 'Czy to jest daleko stad?' },
    { polaco: 'blisko', pronunciacion: 'BLIS-ko', traduccion: 'cerca', ejemplo: 'Sklep jest blisko, tylko 5 minut.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice calle en polaco?', opciones: ['skrzyzowanie', 'ulica', 'na wprost', 'blisko'], correcta: 'ulica' },
    { pregunta: 'Que significa w lewo?', opciones: ['a la derecha', 'recto', 'a la izquierda', 'lejos'], correcta: 'a la izquierda' },
    { pregunta: 'Como se dice cerca en polaco?', opciones: ['daleko', 'blisko', 'na wprost', 'ulica'], correcta: 'blisko' },
    { pregunta: 'Que significa na wprost?', opciones: ['a la derecha', 'a la izquierda', 'recto derecho', 'lejos'], correcta: 'recto derecho' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 53 · Modulo 6</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Pedir direcciones</h1>
          <p className="text-gray-500 mt-2">Aprende a pedir y dar direcciones en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-54" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
