...
export default function Leccion8() {
  ...
  const vocabulario = [
    { polaco: 'Tak', pronunciacion: 'tak', traduccion: 'Si', ejemplo: 'Tak, rozumiem. Si, entiendo.' },
    { polaco: 'Nie', pronunciacion: 'nye', traduccion: 'No', ejemplo: 'Nie, dziekuje. No, gracias.' },
    { polaco: 'Dziekuje', pronunciacion: 'dyen-KU-ye', traduccion: 'Gracias', ejemplo: 'Dziekuje bardzo! Muchas gracias.' },
    { polaco: 'Bardzo dziekuje', pronunciacion: 'BAR-dzo dyen-KU-ye', traduccion: 'Muchas gracias', ejemplo: 'Bardzo dziekuje za pomoc.' },
    { polaco: 'Prosze', pronunciacion: 'PRO-she', traduccion: 'Por favor / De nada', ejemplo: 'Prosze o pomoc. Por favor ayudame.' },
    { polaco: 'Nie ma za co', pronunciacion: 'nye ma za tso', traduccion: 'De nada', ejemplo: 'Dziekuje! Nie ma za co.' },
    { polaco: 'Przepraszam', pronunciacion: 'pshe-PRA-sham', traduccion: 'Perdon / Disculpe', ejemplo: 'Przepraszam, gdzie jest toaleta?' },
    { polaco: 'Rozumiem', pronunciacion: 'ro-ZU-myem', traduccion: 'Entiendo', ejemplo: 'Tak, rozumiem po polsku.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice "Gracias" en polaco?', opciones: ['Prosze', 'Tak', 'Dziekuje', 'Nie'], correcta: 'Dziekuje' },
    { pregunta: 'Que significa "Przepraszam"?', opciones: ['Gracias', 'De nada', 'Perdon', 'Si'], correcta: 'Perdon' },
    { pregunta: 'Como se dice "De nada" en polaco?', opciones: ['Dziekuje', 'Nie ma za co', 'Przepraszam', 'Tak'], correcta: 'Nie ma za co' },
    { pregunta: 'Que significa "Rozumiem"?', opciones: ['Perdon', 'Gracias', 'Entiendo', 'Por favor'], correcta: 'Entiendo' },
    { pregunta: 'Como se dice "Por favor" en polaco?', opciones: ['Tak', 'Nie', 'Dziekuje', 'Prosze'], correcta: 'Prosze' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 8 · Modulo 1</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Si, No, Gracias, Por favor</h1>
          <p className="text-gray-500 mt-2">Palabras esenciales para comunicarte en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-9" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
