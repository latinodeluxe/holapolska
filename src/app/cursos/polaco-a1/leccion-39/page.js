...
export default function Leccion39() {
  ...
  const vocabulario = [
    { polaco: 'Lubie', pronunciacion: 'LU-bye', traduccion: 'Me gusta me gustan', ejemplo: 'Lubie pierogi z miesem.' },
    { polaco: 'Nie lubie', pronunciacion: 'nye LU-bye', traduccion: 'No me gusta', ejemplo: 'Nie lubie brokuli.' },
    { polaco: 'Uwielbiam', pronunciacion: 'u-VYEL-byam', traduccion: 'Me encanta adoro', ejemplo: 'Uwielbiam czekolade.' },
    { polaco: 'slodki', pronunciacion: 'SWOD-ki', traduccion: 'dulce', ejemplo: 'Ten deser jest bardzo slodki.' },
    { polaco: 'slony', pronunciacion: 'SWO-ni', traduccion: 'salado', ejemplo: 'Zupa jest za slona.' },
    { polaco: 'ostry', pronunciacion: 'OS-tri', traduccion: 'picante', ejemplo: 'Nie lubie ostrego jedzenia.' },
    { polaco: 'swieze', pronunciacion: 'SHVYE-zhe', traduccion: 'fresco', ejemplo: 'Wole swieze warzywa.' },
    { polaco: 'smaczne', pronunciacion: 'SMACH-ne', traduccion: 'sabroso rico', ejemplo: 'To jest bardzo smaczne.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice me gusta en polaco?', opciones: ['Nie lubie', 'Uwielbiam', 'Lubie', 'smaczne'], correcta: 'Lubie' },
    { pregunta: 'Que significa ostry?', opciones: ['dulce', 'salado', 'picante', 'fresco'], correcta: 'picante' },
    { pregunta: 'Como se dice me encanta en polaco?', opciones: ['Lubie', 'Uwielbiam', 'Nie lubie', 'slodki'], correcta: 'Uwielbiam' },
    { pregunta: 'Que significa smaczne?', opciones: ['fresco', 'picante', 'dulce', 'sabroso rico'], correcta: 'sabroso rico' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 39 · Modulo 4</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Preferencias de comida</h1>
          <p className="text-gray-500 mt-2">Aprende a expresar tus gustos en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-40" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
