...
export default function Leccion38() {
  ...
  const vocabulario = [
    { polaco: 'gotowac', pronunciacion: 'go-TO-vach', traduccion: 'cocinar', ejemplo: 'Lubie gotowac obiady.' },
    { polaco: 'smazyc', pronunciacion: 'SMA-zhich', traduccion: 'freir', ejemplo: 'Smazyc ziemniaki na oleju.' },
    { polaco: 'gotowac na parze', pronunciacion: 'go-TO-vach na PA-zhe', traduccion: 'cocinar al vapor', ejemplo: 'Warzywa gotowane na parze sa zdrowe.' },
    { polaco: 'piec', pronunciacion: 'pyech', traduccion: 'hornear', ejemplo: 'Pieke ciasto w piekarniku.' },
    { polaco: 'mieszac', pronunciacion: 'MYE-shach', traduccion: 'mezclar', ejemplo: 'Mieszaj skladniki razem.' },
    { polaco: 'kroic', pronunciacion: 'KRO-ich', traduccion: 'cortar', ejemplo: 'Pokroj warzywa w kostke.' },
    { polaco: 'skladniki', pronunciacion: 'skwa-DNIK-i', traduccion: 'ingredientes', ejemplo: 'Jakie skladniki sa potrzebne?' },
    { polaco: 'przepis', pronunciacion: 'PSHEP-is', traduccion: 'receta', ejemplo: 'Mam dobry przepis na bigos.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice cocinar en polaco?', opciones: ['smazyc', 'gotowac', 'kroic', 'piec'], correcta: 'gotowac' },
    { pregunta: 'Que significa przepis?', opciones: ['ingredientes', 'receta', 'mezclar', 'cortar'], correcta: 'receta' },
    { pregunta: 'Como se dice hornear en polaco?', opciones: ['mieszac', 'gotowac', 'piec', 'smazyc'], correcta: 'piec' },
    { pregunta: 'Que significa skladniki?', opciones: ['receta', 'ingredientes', 'freir', 'mezclar'], correcta: 'ingredientes' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 38 · Modulo 4</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Cocinar en casa</h1>
          <p className="text-gray-500 mt-2">Aprende vocabulario de cocina en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-39" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
