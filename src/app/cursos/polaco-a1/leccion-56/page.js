...
export default function Leccion56() {
  ...
  const vocabulario = [
    { polaco: 'hotel', pronunciacion: 'ho-TEL', traduccion: 'hotel', ejemplo: 'Mieszkam w hotelu przez tydzien.' },
    { polaco: 'pokoj', pronunciacion: 'PO-kuy', traduccion: 'habitacion cuarto', ejemplo: 'Chcialbym zarezerwowac pokoj.' },
    { polaco: 'recepcja', pronunciacion: 're-TSEP-tsya', traduccion: 'recepcion', ejemplo: 'Recepcja jest na parterze.' },
    { polaco: 'meldunek', pronunciacion: 'mel-DU-nek', traduccion: 'registro check in', ejemplo: 'Meldunek od czternastej.' },
    { polaco: 'wymeldowanie', pronunciacion: 'vi-mel-do-VA-nye', traduccion: 'check out salida', ejemplo: 'Wymeldowanie do dwunastej.' },
    { polaco: 'sniadanie wliczone', pronunciacion: 'shnya-DA-nye vli-CHO-ne', traduccion: 'desayuno incluido', ejemplo: 'Czy sniadanie jest wliczone w cene?' },
    { polaco: 'klucz do pokoju', pronunciacion: 'kluch do po-KO-yu', traduccion: 'llave de la habitacion', ejemplo: 'Prosze klucz do pokoju numer 305.' },
    { polaco: 'widok', pronunciacion: 'VI-dok', traduccion: 'vista panorama', ejemplo: 'Moj pokoj ma piekny widok na miasto.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice hotel en polaco?', opciones: ['recepcja', 'hotel', 'pokoj', 'meldunek'], correcta: 'hotel' },
    { pregunta: 'Que significa wymeldowanie?', opciones: ['check in', 'reserva', 'check out salida', 'recepcion'], correcta: 'check out salida' },
    { pregunta: 'Como se dice recepcion en polaco?', opciones: ['meldunek', 'hotel', 'recepcja', 'widok'], correcta: 'recepcja' },
    { pregunta: 'Que significa widok?', opciones: ['llave', 'habitacion', 'vista panorama', 'desayuno'], correcta: 'vista panorama' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 56 · Modulo 6</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">En el hotel</h1>
          <p className="text-gray-500 mt-2">Aprende vocabulario de hotel en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-57" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
