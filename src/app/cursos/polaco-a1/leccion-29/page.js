...
export default function Leccion29() {
  ...
  const vocabulario = [
    { polaco: 'Czy moge...?', pronunciacion: 'chi MO-ge', traduccion: 'Puedo...?', ejemplo: 'Czy moge otworzyc okno?' },
    { polaco: 'Prosze wejsc', pronunciacion: 'PRO-she VEISH-ch', traduccion: 'Por favor entra', ejemplo: 'Prosze wejsc, drzwi sa otwarte.' },
    { polaco: 'Chwileczke', pronunciacion: 'hvi-LECH-ke', traduccion: 'Un momento', ejemplo: 'Chwileczke, zaraz otworze.' },
    { polaco: 'Kto tam?', pronunciacion: 'kto tam', traduccion: 'Quien es?', ejemplo: 'Kto tam? To ja, Anna.' },
    { polaco: 'Wejdz', pronunciacion: 'veydz', traduccion: 'Entra', ejemplo: 'Wejdz, prosze.' },
    { polaco: 'Wyjdz', pronunciacion: 'viydz', traduccion: 'Sal', ejemplo: 'Wyjdz na chwile.' },
    { polaco: 'Tu jest cieplo', pronunciacion: 'tu yest CHEP-wo', traduccion: 'Aqui hace calor', ejemplo: 'Tu jest cieplo i przyjemnie.' },
    { polaco: 'Tu jest zimno', pronunciacion: 'tu yest ZIM-no', traduccion: 'Aqui hace frio', ejemplo: 'Tu jest zimno, zamknij okno.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice Puedo en polaco?', opciones: ['Kto tam?', 'Czy moge...?', 'Wejdz', 'Prosze wejsc'], correcta: 'Czy moge...?' },
    { pregunta: 'Que significa Chwileczke?', opciones: ['Entra', 'Sal', 'Un momento', 'Quien es'], correcta: 'Un momento' },
    { pregunta: 'Como se dice Aqui hace frio en polaco?', opciones: ['Tu jest cieplo', 'Tu jest zimno', 'Kto tam', 'Wejdz'], correcta: 'Tu jest zimno' },
    { pregunta: 'Que significa Kto tam?', opciones: ['Entra por favor', 'Un momento', 'Quien es', 'Sal'], correcta: 'Quien es' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 29 · Modulo 3</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Frases en casa</h1>
          <p className="text-gray-500 mt-2">Aprende frases comunes dentro del hogar</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-30" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
