export default function Modulo5() {
  const lecciones = [
    { num: 41, titulo: 'Los dias de la semana' },
    { num: 42, titulo: 'Los meses del ano' },
    { num: 43, titulo: 'Las estaciones' },
    { num: 44, titulo: 'La hora' },
    { num: 45, titulo: 'Rutinas diarias' },
    { num: 46, titulo: 'El calendario' },
    { num: 47, titulo: 'Fechas y cumpleanos' },
    { num: 48, titulo: 'El tiempo atmosferico' },
    { num: 49, titulo: 'Expresiones de tiempo' },
    { num: 50, titulo: 'Repaso del Modulo 5' },
  ]
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Modulo 5</span>
          <h1 className="text-4xl font-bold text-gray-900 mt-1">Tiempo y calendario</h1>
          <p className="text-gray-500 mt-2">10 lecciones · Lecciones 41 a 50</p>
        </div>
