...
export default function Leccion66() {
  ...
  const vocabulario = [
    { polaco: 'silownia', pronunciacion: 'si-WOV-nya', traduccion: 'gimnasio', ejemplo: 'Chodze na silownie trzy razy w tygodniu.' },
    { polaco: 'basen', pronunciacion: 'BA-sen', traduccion: 'piscina', ejemplo: 'Basen jest otwarty od szostej.' },
    { polaco: 'pilka nozna', pronunciacion: 'PIW-ka NOZH-na', traduccion: 'futbol', ejemplo: 'Gram w pilke nozna w weekend.' },
    { polaco: 'tenis', pronunciacion: 'TE-nis', traduccion: 'tenis', ejemplo: 'Lubie grac w tenisa.' },
    { polaco: 'rower', pronunciacion: 'RO-ver', traduccion: 'bicicleta ciclismo', ejemplo: 'Jade na rowerze po parku.' },
    { polaco: 'joga', pronunciacion: 'YO-ga', traduccion: 'yoga', ejemplo: 'Cwicze joge rano.' },
    { polaco: 'spacer', pronunciacion: 'SPA-tser', traduccion: 'paseo caminata', ejemplo: 'Chodze na spacer po kolacji.' },
    { polaco: 'sport', pronunciacion: 'sport', traduccion: 'deporte', ejemplo: 'Sport jest bardzo wazny dla zdrowia.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice gimnasio en polaco?', opciones: ['basen', 'silownia', 'sport', 'joga'], correcta: 'silownia' },
    { pregunta: 'Que significa basen?', opciones: ['gimnasio', 'piscina', 'cancha', 'parque'], correcta: 'piscina' },
    { pregunta: 'Como se dice paseo en polaco?', opciones: ['rower', 'tenis', 'spacer', 'joga'], correcta: 'spacer' },
    { pregunta: 'Que significa pilka nozna?', opciones: ['tenis', 'baloncesto', 'futbol', 'natacion'], correcta: 'futbol' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 66 · Modulo 7</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Deporte y ejercicio</h1>
          <p className="text-gray-500 mt-2">Aprende vocabulario deportivo en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-67" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
