...
export default function Leccion72() {
  ...
  const vocabulario = [
    { polaco: 'szukac pracy', pronunciacion: 'SHU-kach PRA-tsi', traduccion: 'buscar trabajo', ejemplo: 'Szukam pracy od dwoch miesiecy.' },
    { polaco: 'oferta pracy', pronunciacion: 'o-FER-ta PRA-tsi', traduccion: 'oferta de trabajo', ejemplo: 'Znalazlem interesujaca oferte pracy.' },
    { polaco: 'CV', pronunciacion: 'tse-fet', traduccion: 'curriculum vitae', ejemplo: 'Wyslalem CV do firmy.' },
    { polaco: 'list motywacyjny', pronunciacion: 'list mo-ti-va-TSIY-ni', traduccion: 'carta de presentacion', ejemplo: 'Napisalem list motywacyjny.' },
    { polaco: 'rozmowa kwalifikacyjna', pronunciacion: 'roz-MO-va kva-li-fi-ka-TSIY-na', traduccion: 'entrevista de trabajo', ejemplo: 'Mam rozmowe kwalifikacyjna jutro.' },
    { polaco: 'doswiadczenie', pronunciacion: 'dosh-vyad-CHE-nye', traduccion: 'experiencia', ejemplo: 'Mam pieć lat doswiadczenia.' },
    { polaco: 'umiejetnosci', pronunciacion: 'u-mye-YEHT-nosh-chi', traduccion: 'habilidades competencias', ejemplo: 'Jakie masz umiejetnosci?' },
    { polaco: 'zatrudnienie', pronunciacion: 'za-trud-NYE-nye', traduccion: 'empleo contratacion', ejemplo: 'Dostalam zatrudnienie w tej firmie.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice buscar trabajo en polaco?', opciones: ['oferta pracy', 'szukac pracy', 'CV', 'zatrudnienie'], correcta: 'szukac pracy' },
    { pregunta: 'Que significa rozmowa kwalifikacyjna?', opciones: ['curriculum', 'carta de presentacion', 'entrevista de trabajo', 'experiencia'], correcta: 'entrevista de trabajo' },
    { pregunta: 'Como se dice experiencia en polaco?', opciones: ['umiejetnosci', 'zatrudnienie', 'doswiadczenie', 'CV'], correcta: 'doswiadczenie' },
    { pregunta: 'Que significa umiejetnosci?', opciones: ['experiencia', 'habilidades competencias', 'empleo', 'oferta'], correcta: 'habilidades competencias' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 72 · Modulo 8</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Buscar trabajo</h1>
          <p className="text-gray-500 mt-2">Aprende vocabulario para buscar empleo en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-73" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
