...
export default function Leccion26() {
  ...
  const vocabulario = [
    { polaco: 'mieszkac', pronunciacion: 'MYESH-kach', traduccion: 'vivir habitar', ejemplo: 'Mieszkam w Warszawie.' },
    { polaco: 'gotowac', pronunciacion: 'go-TO-vach', traduccion: 'cocinar', ejemplo: 'Lubie gotowac obiady.' },
    { polaco: 'sprzatac', pronunciacion: 'SPZHON-tach', traduccion: 'limpiar ordenar', ejemplo: 'Sprzatam dom w weekend.' },
    { polaco: 'myc', pronunciacion: 'mich', traduccion: 'lavar limpiar', ejemplo: 'Myje naczynia po obiedzie.' },
    { polaco: 'spac', pronunciacion: 'spach', traduccion: 'dormir', ejemplo: 'Spie osiem godzin dziennie.' },
    { polaco: 'jesc', pronunciacion: 'yeshch', traduccion: 'comer', ejemplo: 'Jemy obiad o drugiej.' },
    { polaco: 'pic', pronunciacion: 'pich', traduccion: 'beber', ejemplo: 'Pije kawe rano.' },
    { polaco: 'ogladac', pronunciacion: 'og-LON-dach', traduccion: 'ver mirar', ejemplo: 'Ogladam filmy wieczorem.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice vivir en polaco?', opciones: ['gotowac', 'mieszkac', 'sprzatac', 'spac'], correcta: 'mieszkac' },
    { pregunta: 'Que significa gotowac?', opciones: ['limpiar', 'dormir', 'cocinar', 'comer'], correcta: 'cocinar' },
    { pregunta: 'Como se dice dormir en polaco?', opciones: ['jesc', 'pic', 'spac', 'myc'], correcta: 'spac' },
    { pregunta: 'Que significa ogladac?', opciones: ['comer', 'beber', 'lavar', 'ver mirar'], correcta: 'ver mirar' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 26 · Modulo 3</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Verbos del hogar</h1>
          <p className="text-gray-500 mt-2">Aprende los verbos de actividades en casa</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-27" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
