...
export default function Leccion69() {
  ...
  const vocabulario = [
    { polaco: 'Jak sie czujesz?', pronunciacion: 'yak she CHU-yesh', traduccion: 'Como te sientes?', ejemplo: 'Jak sie czujesz dzisiaj?' },
    { polaco: 'Czuje sie dobrze', pronunciacion: 'CHU-ye she DOB-zhe', traduccion: 'Me siento bien', ejemplo: 'Dziekuje, czuje sie dobrze.' },
    { polaco: 'Czuje sie lepiej', pronunciacion: 'CHU-ye she LEP-yey', traduccion: 'Me siento mejor', ejemplo: 'Po lekach czuje sie lepiej.' },
    { polaco: 'Musze odpoczac', pronunciacion: 'MU-she od-PO-chach', traduccion: 'Necesito descansar', ejemplo: 'Musze odpoczac przez kilka dni.' },
    { polaco: 'Jestem w swietnej formie', pronunciacion: 'YES-tem v SHVYET-ney FOR-mye', traduccion: 'Estoy en excelente forma', ejemplo: 'Po urlopie jestem w swietnej formie.' },
    { polaco: 'dbac o siebie', pronunciacion: 'dbach o SHE-bye', traduccion: 'cuidarse', ejemplo: 'Wazne jest dbac o siebie.' },
    { polaco: 'samopoczucie', pronunciacion: 'sa-mo-po-CHU-che', traduccion: 'bienestar estado de animo', ejemplo: 'Jak jest twoje samopoczucie?' },
    { polaco: 'wyzdrowiec', pronunciacion: 'viz-DRO-vyech', traduccion: 'recuperarse sanar', ejemplo: 'Mam nadzieje ze szybko wyzdrowiejesz.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se pregunta como te sientes en polaco?', opciones: ['Jak sie masz?', 'Jak sie czujesz?', 'Co slychac?', 'Jak leci?'], correcta: 'Jak sie czujesz?' },
    { pregunta: 'Que significa Czuje sie lepiej?', opciones: ['Me siento mal', 'Me siento mejor', 'Me siento bien', 'Estoy cansado'], correcta: 'Me siento mejor' },
    { pregunta: 'Como se dice cuidarse en polaco?', opciones: ['wyzdrowiec', 'odpoczac', 'dbac o siebie', 'samopoczucie'], correcta: 'dbac o siebie' },
    { pregunta: 'Que significa wyzdrowiec?', opciones: ['descansar', 'cuidarse', 'recuperarse sanar', 'sentirse bien'], correcta: 'recuperarse sanar' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 69 · Modulo 7</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Como te sientes</h1>
          <p className="text-gray-500 mt-2">Aprende a expresar como te sientes en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-70" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
