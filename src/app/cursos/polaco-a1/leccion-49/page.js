...
export default function Leccion49() {
  ...
  const vocabulario = [
    { polaco: 'czesto', pronunciacion: 'CHES-to', traduccion: 'frecuentemente', ejemplo: 'Czesto chodze na spacery.' },
    { polaco: 'rzadko', pronunciacion: 'ZHAT-ko', traduccion: 'raramente pocas veces', ejemplo: 'Rzadko ogladam telewizje.' },
    { polaco: 'zawsze', pronunciacion: 'ZAV-she', traduccion: 'siempre', ejemplo: 'Zawsze myje rece przed jedzeniem.' },
    { polaco: 'nigdy', pronunciacion: 'NIK-di', traduccion: 'nunca', ejemplo: 'Nigdy nie spie po poludniu.' },
    { polaco: 'czasami', pronunciacion: 'cha-SA-mi', traduccion: 'a veces', ejemplo: 'Czasami chodze do kina.' },
    { polaco: 'co dzien', pronunciacion: 'tso dzhen', traduccion: 'cada dia todos los dias', ejemplo: 'Co dzien biore prysznic.' },
    { polaco: 'raz w tygodniu', pronunciacion: 'ras v ti-GOD-nyu', traduccion: 'una vez a la semana', ejemplo: 'Raz w tygodniu chodze na silownie.' },
    { polaco: 'dlugo', pronunciacion: 'DWU-go', traduccion: 'mucho tiempo largo rato', ejemplo: 'Dlugo czekalem na autobus.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice siempre en polaco?', opciones: ['nigdy', 'czesto', 'zawsze', 'rzadko'], correcta: 'zawsze' },
    { pregunta: 'Que significa nigdy?', opciones: ['siempre', 'a veces', 'frecuentemente', 'nunca'], correcta: 'nunca' },
    { pregunta: 'Como se dice a veces en polaco?', opciones: ['zawsze', 'czasami', 'czesto', 'rzadko'], correcta: 'czasami' },
    { pregunta: 'Que significa rzadko?', opciones: ['siempre', 'frecuentemente', 'raramente pocas veces', 'nunca'], correcta: 'raramente pocas veces' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 49 · Modulo 5</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Expresiones de frecuencia</h1>
          <p className="text-gray-500 mt-2">Aprende a expresar frecuencia en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-50" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
