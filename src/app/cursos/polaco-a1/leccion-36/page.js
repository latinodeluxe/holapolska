...
export default function Leccion36() {
  ...
  const vocabulario = [
    { polaco: 'sklep', pronunciacion: 'sklep', traduccion: 'tienda', ejemplo: 'Ide do sklepu po chleb.' },
    { polaco: 'supermarket', pronunciacion: 'su-per-MAR-ket', traduccion: 'supermercado', ejemplo: 'W supermarkecie jest wszystko.' },
    { polaco: 'kasa', pronunciacion: 'KA-sa', traduccion: 'caja registradora', ejemplo: 'Kolejka do kasy jest dluga.' },
    { polaco: 'koszyk', pronunciacion: 'KO-shik', traduccion: 'cesta canasta', ejemplo: 'Wkloz to do koszyka.' },
    { polaco: 'wozek', pronunciacion: 'VO-zek', traduccion: 'carrito', ejemplo: 'Potrzebuje wozek na zakupy.' },
    { polaco: 'oferta', pronunciacion: 'o-FER-ta', traduccion: 'oferta promocion', ejemplo: 'Ta oferta jest super.' },
    { polaco: 'cena', pronunciacion: 'TSE-na', traduccion: 'precio', ejemplo: 'Jaka jest cena tego produktu?' },
    { polaco: 'przecena', pronunciacion: 'pshe-TSE-na', traduccion: 'descuento rebaja', ejemplo: 'Jest przecena 50 procent.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice supermercado en polaco?', opciones: ['sklep', 'supermarket', 'kasa', 'koszyk'], correcta: 'supermarket' },
    { pregunta: 'Que significa cena?', opciones: ['oferta', 'descuento', 'precio', 'cesta'], correcta: 'precio' },
    { pregunta: 'Como se dice carrito en polaco?', opciones: ['koszyk', 'wozek', 'kasa', 'sklep'], correcta: 'wozek' },
    { pregunta: 'Que significa przecena?', opciones: ['precio', 'oferta', 'descuento rebaja', 'caja'], correcta: 'descuento rebaja' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 36 · Modulo 4</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">En el supermercado</h1>
          <p className="text-gray-500 mt-2">Aprende a hacer compras en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-37" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
