...
export default function Leccion58() {
  ...
  const vocabulario = [
    { polaco: 'Warszawa', pronunciacion: 'var-SHA-va', traduccion: 'Varsovia', ejemplo: 'Warszawa jest stolica Polski.' },
    { polaco: 'Krakow', pronunciacion: 'KRA-kuf', traduccion: 'Cracovia', ejemplo: 'Krakow jest pieknym miastem.' },
    { polaco: 'Gdansk', pronunciacion: 'GDANSK', traduccion: 'Gdansk', ejemplo: 'Gdansk jest nad Baltykiem.' },
    { polaco: 'Morze Baltyckie', pronunciacion: 'MO-zhe baw-TIK-ye', traduccion: 'Mar Baltico', ejemplo: 'Latem jedzie nad Morze Baltyckie.' },
    { polaco: 'gory', pronunciacion: 'GU-ri', traduccion: 'montanas', ejemplo: 'Tatry to najwyzsze gory w Polsce.' },
    { polaco: 'jezioro', pronunciacion: 'ye-ZYO-ro', traduccion: 'lago', ejemplo: 'Mazury maja wiele jezior.' },
    { polaco: 'rzeka', pronunciacion: 'ZHE-ka', traduccion: 'rio', ejemplo: 'Wisla to najdluzsza rzeka w Polsce.' },
    { polaco: 'las', pronunciacion: 'las', traduccion: 'bosque selva', ejemplo: 'Polska ma wiele lasow.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice Varsovia en polaco?', opciones: ['Krakow', 'Gdansk', 'Warszawa', 'Poznan'], correcta: 'Warszawa' },
    { pregunta: 'Que significa gory?', opciones: ['lago', 'rio', 'bosque', 'montanas'], correcta: 'montanas' },
    { pregunta: 'Como se dice lago en polaco?', opciones: ['rzeka', 'las', 'jezioro', 'gory'], correcta: 'jezioro' },
    { pregunta: 'Que significa las?', opciones: ['rio', 'lago', 'bosque selva', 'montanas'], correcta: 'bosque selva' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 58 · Modulo 6</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Ciudades y naturaleza de Polonia</h1>
          <p className="text-gray-500 mt-2">Aprende sobre los lugares de Polonia</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-59" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
