...
export default function Leccion32() {
  ...
  const vocabulario = [
    { polaco: 'jablko', pronunciacion: 'YAB-ko', traduccion: 'manzana', ejemplo: 'Lubie jesc jablka.' },
    { polaco: 'banan', pronunciacion: 'BA-nan', traduccion: 'platano', ejemplo: 'Banan jest zolty.' },
    { polaco: 'pomarancza', pronunciacion: 'po-ma-RAN-cha', traduccion: 'naranja', ejemplo: 'Sok z pomaranczy jest pyszny.' },
    { polaco: 'truskawka', pronunciacion: 'trus-KAV-ka', traduccion: 'fresa', ejemplo: 'Truskawki sa slodkie.' },
    { polaco: 'ziemniak', pronunciacion: 'ZHEM-nyak', traduccion: 'papa patata', ejemplo: 'Ziemniaki z maslem sa pyszne.' },
    { polaco: 'marchew', pronunciacion: 'MAR-hev', traduccion: 'zanahoria', ejemplo: 'Marchew jest zdrowa.' },
    { polaco: 'pomidor', pronunciacion: 'po-MI-dor', traduccion: 'tomate', ejemplo: 'Pomidory sa czerwone.' },
    { polaco: 'cebula', pronunciacion: 'tse-BU-la', traduccion: 'cebolla', ejemplo: 'Cebula placze przy krojeniu.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice manzana en polaco?', opciones: ['banan', 'jablko', 'truskawka', 'pomarancza'], correcta: 'jablko' },
    { pregunta: 'Que significa marchew?', opciones: ['tomate', 'cebolla', 'papa', 'zanahoria'], correcta: 'zanahoria' },
    { pregunta: 'Como se dice tomate en polaco?', opciones: ['cebula', 'ziemniak', 'pomidor', 'marchew'], correcta: 'pomidor' },
    { pregunta: 'Que significa truskawka?', opciones: ['naranja', 'platano', 'fresa', 'manzana'], correcta: 'fresa' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 32 · Modulo 4</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Frutas y verduras</h1>
          <p className="text-gray-500 mt-2">Aprende las frutas y verduras en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-33" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
