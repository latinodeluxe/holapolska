...
export default function Leccion77() {
  ...
  const vocabulario = [
    { polaco: 'godziny pracy', pronunciacion: 'go-DZI-ni PRA-tsi', traduccion: 'horario de trabajo', ejemplo: 'Moje godziny pracy to 9 do 17.' },
    { polaco: 'praca na pelny etat', pronunciacion: 'PRA-tsa na PEW-ni E-tat', traduccion: 'trabajo a tiempo completo', ejemplo: 'Szukam pracy na pelny etat.' },
    { polaco: 'praca na pol etatu', pronunciacion: 'PRA-tsa na puw e-TA-tu', traduccion: 'trabajo a tiempo parcial', ejemplo: 'Pracuje na pol etatu i studiuje.' },
    { polaco: 'praca zdalna', pronunciacion: 'PRA-tsa ZDAL-na', traduccion: 'trabajo remoto teletrabajo', ejemplo: 'Od pandemii pracuje zdalnie.' },
    { polaco: 'nadgodziny', pronunciacion: 'nad-go-DZI-ni', traduccion: 'horas extras', ejemplo: 'Mam duzo nadgodzin w tym miesiacu.' },
    { polaco: 'przerwa', pronunciacion: 'PSHER-va', traduccion: 'descanso pausa', ejemplo: 'Mam przerwe na lunch o trzynastej.' },
    { polaco: 'zmiana', pronunciacion: 'ZMYA-na', traduccion: 'turno', ejemplo: 'Pracuje na nocnej zmianie.' },
    { polaco: 'elastyczne godziny', pronunciacion: 'e-las-TICH-ne go-DZI-ni', traduccion: 'horario flexible', ejemplo: 'Mam elastyczne godziny pracy.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice horario de trabajo en polaco?', opciones: ['przerwa', 'godziny pracy', 'zmiana', 'nadgodziny'], correcta: 'godziny pracy' },
    { pregunta: 'Que significa praca zdalna?', opciones: ['tiempo completo', 'tiempo parcial', 'trabajo remoto teletrabajo', 'turno'], correcta: 'trabajo remoto teletrabajo' },
    { pregunta: 'Como se dice horas extras en polaco?', opciones: ['przerwa', 'zmiana', 'nadgodziny', 'elastyczne'], correcta: 'nadgodziny' },
    { pregunta: 'Que significa przerwa?', opciones: ['turno', 'descanso pausa', 'horario flexible', 'horas extras'], correcta: 'descanso pausa' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 77 · Modulo 8</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Horarios y turnos</h1>
          <p className="text-gray-500 mt-2">Aprende a hablar de horarios laborales en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-78" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
