...
export default function Leccion61() {
  ...
  const vocabulario = [
    { polaco: 'glowa', pronunciacion: 'GWO-va', traduccion: 'cabeza', ejemplo: 'Boli mnie glowa.' },
    { polaco: 'twarz', pronunciacion: 'tvazh', traduccion: 'cara rostro', ejemplo: 'Ma piekna twarz.' },
    { polaco: 'oko', pronunciacion: 'O-ko', traduccion: 'ojo', ejemplo: 'Mam niebieskie oczy.' },
    { polaco: 'nos', pronunciacion: 'nos', traduccion: 'nariz', ejemplo: 'Mam katar w nosie.' },
    { polaco: 'usta', pronunciacion: 'US-ta', traduccion: 'boca labios', ejemplo: 'Myj zeby po posilku.' },
    { polaco: 'ucho', pronunciacion: 'U-ho', traduccion: 'oreja oido', ejemplo: 'Boli mnie ucho.' },
    { polaco: 'reka', pronunciacion: 'REN-ka', traduccion: 'mano brazo', ejemplo: 'Zlamalem reke.' },
    { polaco: 'noga', pronunciacion: 'NO-ga', traduccion: 'pierna pie', ejemplo: 'Boli mnie noga.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice cabeza en polaco?', opciones: ['twarz', 'glowa', 'oko', 'nos'], correcta: 'glowa' },
    { pregunta: 'Que significa ucho?', opciones: ['ojo', 'nariz', 'oreja oido', 'boca'], correcta: 'oreja oido' },
    { pregunta: 'Como se dice mano en polaco?', opciones: ['noga', 'reka', 'ucho', 'twarz'], correcta: 'reka' },
    { pregunta: 'Que significa noga?', opciones: ['mano', 'cabeza', 'pierna pie', 'cara'], correcta: 'pierna pie' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 61 · Modulo 7</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">El cuerpo humano</h1>
          <p className="text-gray-500 mt-2">Aprende las partes del cuerpo en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-62" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
