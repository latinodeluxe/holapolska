...
export default function Leccion35() {
  ...
  const vocabulario = [
    { polaco: 'Prosze o rachunek', pronunciacion: 'PRO-she o ra-HU-nek', traduccion: 'La cuenta por favor', ejemplo: 'Prosze o rachunek, juz konczymy.' },
    { polaco: 'Ile to kosztuje?', pronunciacion: 'EE-le to kosh-TU-ye', traduccion: 'Cuanto cuesta?', ejemplo: 'Ile to kosztuje razem?' },
    { polaco: 'platnosc karta', pronunciacion: 'PWAT-noshch KAR-ta', traduccion: 'pago con tarjeta', ejemplo: 'Czy mozna platnosc karta?' },
    { polaco: 'gotowka', pronunciacion: 'go-TOV-ka', traduccion: 'efectivo', ejemplo: 'Place gotowka.' },
    { polaco: 'reszta', pronunciacion: 'RESH-ta', traduccion: 'cambio vuelto', ejemplo: 'Prosze o reszte.' },
    { polaco: 'paragon', pronunciacion: 'pa-RA-gon', traduccion: 'ticket recibo', ejemplo: 'Prosze o paragon.' },
    { polaco: 'za drogo', pronunciacion: 'za DRO-go', traduccion: 'muy caro', ejemplo: 'To jest za drogo dla mnie.' },
    { polaco: 'w porzadku', pronunciacion: 'v po-ZHON-dku', traduccion: 'de acuerdo esta bien', ejemplo: 'W porzadku, zaplace.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice la cuenta por favor en polaco?', opciones: ['Ile to kosztuje', 'Prosze o rachunek', 'gotowka', 'paragon'], correcta: 'Prosze o rachunek' },
    { pregunta: 'Que significa gotowka?', opciones: ['tarjeta', 'efectivo', 'cambio', 'recibo'], correcta: 'efectivo' },
    { pregunta: 'Como se dice cuanto cuesta en polaco?', opciones: ['reszta', 'za drogo', 'Ile to kosztuje?', 'w porzadku'], correcta: 'Ile to kosztuje?' },
    { pregunta: 'Que significa reszta?', opciones: ['recibo', 'efectivo', 'cambio vuelto', 'tarjeta'], correcta: 'cambio vuelto' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 35 · Modulo 4</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">La cuenta por favor</h1>
          <p className="text-gray-500 mt-2">Aprende a pagar en un restaurante polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-36" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
