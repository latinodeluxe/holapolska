...
export default function Leccion57() {
  ...
  const vocabulario = [
    { polaco: 'mapa', pronunciacion: 'MA-pa', traduccion: 'mapa', ejemplo: 'Mam mape miasta.' },
    { polaco: 'turysta', pronunciacion: 'tu-RIS-ta', traduccion: 'turista', ejemplo: 'Jestem turystka z Meksyku.' },
    { polaco: 'atrakcja turystyczna', pronunciacion: 'at-RAKT-sya tu-ris-TICH-na', traduccion: 'atraccion turistica', ejemplo: 'Jakie sa glowne atrakcje turystyczne?' },
    { polaco: 'zdjecie', pronunciacion: 'ZDYE-che', traduccion: 'foto fotografia', ejemplo: 'Czy moge zrobic zdjecie?' },
    { polaco: 'pamiatka', pronunciacion: 'pa-MYONT-ka', traduccion: 'recuerdo souvenir', ejemplo: 'Kupuje pamiatki dla rodziny.' },
    { polaco: 'przewodnik', pronunciacion: 'pshe-VOD-nik', traduccion: 'guia turistico', ejemplo: 'Przewodnik opowiada o historii.' },
    { polaco: 'wycieczka', pronunciacion: 'vi-CHECH-ka', traduccion: 'excursion viaje', ejemplo: 'Zapisalem sie na wycieczke.' },
    { polaco: 'biuro podrozy', pronunciacion: 'BYU-ro pod-RU-zhi', traduccion: 'agencia de viajes', ejemplo: 'Rezerwuje w biurze podrozy.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice turista en polaco?', opciones: ['mapa', 'turysta', 'przewodnik', 'wycieczka'], correcta: 'turysta' },
    { pregunta: 'Que significa zdjecie?', opciones: ['mapa', 'recuerdo', 'foto fotografia', 'guia'], correcta: 'foto fotografia' },
    { pregunta: 'Como se dice excursion en polaco?', opciones: ['pamiatka', 'wycieczka', 'mapa', 'turysta'], correcta: 'wycieczka' },
    { pregunta: 'Que significa pamiatka?', opciones: ['foto', 'excursion', 'recuerdo souvenir', 'mapa'], correcta: 'recuerdo souvenir' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 57 · Modulo 6</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Turismo y viajes</h1>
          <p className="text-gray-500 mt-2">Aprende vocabulario de turismo en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-58" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
