...
export default function Leccion13() {
  ...
  const vocabulario = [
    { polaco: 'lekarz', pronunciacion: 'LE-kazh', traduccion: 'medico', ejemplo: 'Moj tata jest lekarzem.' },
    { polaco: 'nauczyciel', pronunciacion: 'na-u-CHI-chel', traduccion: 'profesor', ejemplo: 'Ona jest nauczycielka.' },
    { polaco: 'inzynier', pronunciacion: 'in-ZHI-ner', traduccion: 'ingeniero', ejemplo: 'Jestem inzynierem.' },
    { polaco: 'prawnik', pronunciacion: 'PRAV-nik', traduccion: 'abogado', ejemplo: 'Moj brat jest prawnikiem.' },
    { polaco: 'kucharz', pronunciacion: 'KU-hazh', traduccion: 'cocinero', ejemplo: 'On jest swietnym kucharzem.' },
    { polaco: 'kierowca', pronunciacion: 'kye-ROV-tsa', traduccion: 'conductor', ejemplo: 'Moj wujek jest kierowca.' },
    { polaco: 'student', pronunciacion: 'STOO-dent', traduccion: 'estudiante', ejemplo: 'Jestem studentem medycyny.' },
    { polaco: 'pracownik', pronunciacion: 'pra-TSO-vnik', traduccion: 'empleado', ejemplo: 'Jestem pracownikiem banku.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice medico en polaco?', opciones: ['prawnik', 'lekarz', 'kucharz', 'student'], correcta: 'lekarz' },
    { pregunta: 'Que significa nauczyciel?', opciones: ['medico', 'abogado', 'profesor', 'ingeniero'], correcta: 'profesor' },
    { pregunta: 'Como se dice abogado en polaco?', opciones: ['lekarz', 'kucharz', 'prawnik', 'kierowca'], correcta: 'prawnik' },
    { pregunta: 'Que significa kucharz?', opciones: ['conductor', 'cocinero', 'empleado', 'estudiante'], correcta: 'cocinero' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 13 · Modulo 2</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Profesiones</h1>
          <p className="text-gray-500 mt-2">Aprende las profesiones mas comunes en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-14" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
