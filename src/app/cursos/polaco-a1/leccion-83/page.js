...
export default function Leccion83() {
  ...
  const vocabulario = [
    { polaco: 'Chcialbym otworzyc konto', pronunciacion: 'HCHAW-bim ot-VO-zhich KON-to', traduccion: 'Quisiera abrir una cuenta', ejemplo: 'Chcialbym otworzyc konto bankowe.' },
    { polaco: 'przelew', pronunciacion: 'PSHE-lev', traduccion: 'transferencia bancaria', ejemplo: 'Chce zrobic przelew na 500 zlotych.' },
    { polaco: 'wyplata', pronunciacion: 'VI-pwa-ta', traduccion: 'retiro extraccion', ejemplo: 'Chce wyplacic 200 zlotych.' },
    { polaco: 'wplata', pronunciacion: 'VPWA-ta', traduccion: 'deposito ingreso', ejemplo: 'Chce wplacic pieniadze na konto.' },
    { polaco: 'karta platnicza', pronunciacion: 'KAR-ta pwat-NI-cha', traduccion: 'tarjeta de debito', ejemplo: 'Czy moge zaplacic karta platnicza?' },
    { polaco: 'bankomat', pronunciacion: 'ban-KO-mat', traduccion: 'cajero automatico', ejemplo: 'Bankomat jest za rogiem.' },
    { polaco: 'saldo', pronunciacion: 'SAL-do', traduccion: 'saldo balance', ejemplo: 'Chce sprawdzic saldo konta.' },
    { polaco: 'odsetki', pronunciacion: 'od-SET-ki', traduccion: 'intereses', ejemplo: 'Jakie sa odsetki od kredytu?' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice transferencia bancaria en polaco?', opciones: ['wyplata', 'przelew', 'wplata', 'saldo'], correcta: 'przelew' },
    { pregunta: 'Que significa bankomat?', opciones: ['banco', 'tarjeta', 'cajero automatico', 'saldo'], correcta: 'cajero automatico' },
    { pregunta: 'Como se dice deposito en polaco?', opciones: ['wyplata', 'przelew', 'wplata', 'odsetki'], correcta: 'wplata' },
    { pregunta: 'Que significa saldo?', opciones: ['intereses', 'transferencia', 'saldo balance', 'retiro'], correcta: 'saldo balance' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 83 · Modulo 9</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">En el banco</h1>
          <p className="text-gray-500 mt-2">Aprende a hacer operaciones bancarias en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-84" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
