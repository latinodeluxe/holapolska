...
export default function Leccion51() {
  ...
  const vocabulario = [
    { polaco: 'autobus', pronunciacion: 'au-TO-bus', traduccion: 'autobus', ejemplo: 'Jade autobusem do centrum.' },
    { polaco: 'tramwaj', pronunciacion: 'TRAM-vay', traduccion: 'tranvia', ejemplo: 'Tramwaj numer 5 jedzie na dworzec.' },
    { polaco: 'metro', pronunciacion: 'ME-tro', traduccion: 'metro subte', ejemplo: 'W Warszawie jest metro.' },
    { polaco: 'pociag', pronunciacion: 'PO-chong', traduccion: 'tren', ejemplo: 'Jade pociagiem do Krakowa.' },
    { polaco: 'samochod', pronunciacion: 'sa-MO-hut', traduccion: 'coche auto', ejemplo: 'Moj samochod jest czerwony.' },
    { polaco: 'rower', pronunciacion: 'RO-ver', traduccion: 'bicicleta', ejemplo: 'Jade na rowerze do pracy.' },
    { polaco: 'taksowka', pronunciacion: 'tak-SOV-ka', traduccion: 'taxi', ejemplo: 'Zamawiam taksowke przez aplikacje.' },
    { polaco: 'samolot', pronunciacion: 'sa-MO-lot', traduccion: 'avion', ejemplo: 'Lecimy samolotem do Madrytu.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice autobus en polaco?', opciones: ['tramwaj', 'autobus', 'metro', 'pociag'], correcta: 'autobus' },
    { pregunta: 'Que significa samolot?', opciones: ['tren', 'taxi', 'bicicleta', 'avion'], correcta: 'avion' },
    { pregunta: 'Como se dice tren en polaco?', opciones: ['pociag', 'rower', 'samochod', 'taksowka'], correcta: 'pociag' },
    { pregunta: 'Que significa rower?', opciones: ['coche', 'metro', 'bicicleta', 'tranvia'], correcta: 'bicicleta' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 51 · Modulo 6</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Medios de transporte</h1>
          <p className="text-gray-500 mt-2">Aprende los transportes en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-52" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
