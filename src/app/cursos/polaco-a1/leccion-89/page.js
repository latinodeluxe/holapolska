...
export default function Leccion89() {
  ...
  const vocabulario = [
    { polaco: 'Przepraszam ze przeszkadzam', pronunciacion: 'pshe-PRA-sham zhe pshe-SHKA-dzam', traduccion: 'Disculpe que le moleste', ejemplo: 'Przepraszam ze przeszkadzam, mam pytanie.' },
    { polaco: 'Czy mogę prosić o...?', pronunciacion: 'chi MO-ge PRO-shich o', traduccion: 'Podria pedirle...?', ejemplo: 'Czy moge prosic o szklankę wody?' },
    { polaco: 'Z przyjemnością', pronunciacion: 'z pshi-yem-NOSH-chyom', traduccion: 'Con mucho gusto', ejemplo: 'Z przyjemnością, oto pańska kawa.' },
    { polaco: 'Bardzo uprzejmy', pronunciacion: 'BAR-dzo u-PZHEY-mi', traduccion: 'Muy amable', ejemplo: 'Bardzo uprzejmy z pańskiej strony.' },
    { polaco: 'Nie ma problemu', pronunciacion: 'nye ma pro-BLE-mu', traduccion: 'No hay problema', ejemplo: 'Nie ma problemu, zrobie to chętnie.' },
    { polaco: 'Rozumiem pańską sytuację', pronunciacion: 'ro-ZU-myem PAN-skom si-TU-a-tsye', traduccion: 'Entiendo su situacion', ejemplo: 'Rozumiem pańską sytuację i postaram się pomóc.' },
    { polaco: 'Czy to pilne?', pronunciacion: 'chi to PIL-ne', traduccion: 'Es urgente?', ejemplo: 'Czy to pilne czy mogę to zrobić jutro?' },
    { polaco: 'Oczywiście', pronunciacion: 'o-chi-VISH-che', traduccion: 'Por supuesto claro', ejemplo: 'Oczywiście, nie ma sprawy.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice con mucho gusto en polaco?', opciones: ['Nie ma problemu', 'Z przyjemnością', 'Oczywiście', 'Bardzo uprzejmy'], correcta: 'Z przyjemnością' },
    { pregunta: 'Que significa Nie ma problemu?', opciones: ['Con mucho gusto', 'No hay problema', 'Por supuesto', 'Muy amable'], correcta: 'No hay problema' },
    { pregunta: 'Como se dice por supuesto en polaco?', opciones: ['Z przyjemnością', 'Oczywiście', 'Nie ma problemu', 'Bardzo uprzejmy'], correcta: 'Oczywiście' },
    { pregunta: 'Que significa Czy to pilne?', opciones: ['Es dificil', 'Es urgente', 'Es posible', 'Es necesario'], correcta: 'Es urgente' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 89 · Modulo 9</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Situaciones cotidianas</h1>
          <p className="text-gray-500 mt-2">Aprende frases para situaciones del dia a dia en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-90" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
