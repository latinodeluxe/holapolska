...
export default function Leccion4() {
  ...
  const vocabulario = [
    { polaco: 'Ile masz lat?', pronunciacion: 'EE-le mash lat', traduccion: 'Cuantos anos tienes?', ejemplo: 'Ile masz lat? Mam dwadziescia lat.' },
    { polaco: 'Mam ... lat', pronunciacion: 'mam ... lat', traduccion: 'Tengo ... anos', ejemplo: 'Mam trzydziesci lat.' },
    { polaco: 'jeden', pronunciacion: 'YE-den', traduccion: 'uno', ejemplo: 'Mam jeden rok.' },
    { polaco: 'dwa', pronunciacion: 'dva', traduccion: 'dos', ejemplo: 'Mam dwa lata.' },
    { polaco: 'trzy', pronunciacion: 'tshi', traduccion: 'tres', ejemplo: 'Mam trzy lata.' },
    { polaco: 'cztery', pronunciacion: 'CHTE-ri', traduccion: 'cuatro', ejemplo: 'Mam cztery lata.' },
    { polaco: 'piec', pronunciacion: 'pyench', traduccion: 'cinco', ejemplo: 'Mam piec lat.' },
    { polaco: 'rok / lata / lat', pronunciacion: 'rok / LA-ta / lat', traduccion: 'ano / anos', ejemplo: 'Mam dwadziescia lat.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se pregunta la edad en polaco?', opciones: ['Jak sie nazywasz?', 'Ile masz lat?', 'Skad jestes?', 'Milo mi'], correcta: 'Ile masz lat?' },
    { pregunta: 'Como se dice "Tengo 20 anos" en polaco?', opciones: ['Jestem 20', 'Mam 20 lat', 'Ile masz 20', 'Rok 20'], correcta: 'Mam 20 lat' },
    { pregunta: 'Que significa "trzy"?', opciones: ['uno', 'dos', 'tres', 'cuatro'], correcta: 'tres' },
    { pregunta: 'Como se dice "cinco" en polaco?', opciones: ['jeden', 'dwa', 'cztery', 'piec'], correcta: 'piec' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 4 · Modulo 1</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Cuantos anos tienes</h1>
          <p className="text-gray-500 mt-2">Aprende a hablar de la edad en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-5" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
