...
export default function Leccion81() {
  ...
  const vocabulario = [
    { polaco: 'Dzien dobry, w czym moge pomoc?', pronunciacion: 'dyen DOB-ri, v chim MO-ge PO-mots', traduccion: 'Buenos dias en que puedo ayudarle?', ejemplo: 'Sprzedawca: Dzien dobry, w czym moge pomoc?' },
    { polaco: 'Szukam...', pronunciacion: 'SHU-kam', traduccion: 'Busco...', ejemplo: 'Szukam kurtki w rozmiarze M.' },
    { polaco: 'Ile to kosztuje?', pronunciacion: 'EE-le to kosh-TU-ye', traduccion: 'Cuanto cuesta esto?', ejemplo: 'Ile kosztuje ta bluzka?' },
    { polaco: 'Czy mogerzymiaryc?', pronunciacion: 'chi MO-ge pshi-MYE-zhich', traduccion: 'Puedo probarmelo?', ejemplo: 'Czy mogerzymiaryc te spodnie?' },
    { polaco: 'Za duze', pronunciacion: 'za DU-zhe', traduccion: 'Demasiado grande', ejemplo: 'To jest za duze dla mnie.' },
    { polaco: 'Za male', pronunciacion: 'za MA-we', traduccion: 'Demasiado pequeno', ejemplo: 'Ten rozmiar jest za maly.' },
    { polaco: 'Wezme to', pronunciacion: 'VEZH-me to', traduccion: 'Me lo llevo', ejemplo: 'Wezme to w kolorze niebieskim.' },
    { polaco: 'Czy jest na wyprzedazy?', pronunciacion: 'chi yest na vi-pshe-DA-zhi', traduccion: 'Esta en oferta rebajas?', ejemplo: 'Czy te buty sa na wyprzedazy?' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice busco en polaco?', opciones: ['Wezme to', 'Szukam', 'Ile kosztuje', 'Za duze'], correcta: 'Szukam' },
    { pregunta: 'Que significa Wezme to?', opciones: ['Cuanto cuesta', 'Demasiado grande', 'Me lo llevo', 'Puedo probarmelo'], correcta: 'Me lo llevo' },
    { pregunta: 'Como se dice demasiado pequeno en polaco?', opciones: ['Za duze', 'Za male', 'Szukam', 'Wezme to'], correcta: 'Za male' },
    { pregunta: 'Que significa wyprzedaz?', opciones: ['precio', 'tienda', 'oferta rebajas', 'talla'], correcta: 'oferta rebajas' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 81 · Modulo 9</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">En la tienda</h1>
          <p className="text-gray-500 mt-2">Aprende a comprar ropa en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-82" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
