...
export default function Leccion46() {
  ...
  const vocabulario = [
    { polaco: 'dzisiaj', pronunciacion: 'DZHI-shay', traduccion: 'hoy', ejemplo: 'Dzisiaj mam duzo pracy.' },
    { polaco: 'jutro', pronunciacion: 'YU-tro', traduccion: 'manana', ejemplo: 'Jutro ide do lekarza.' },
    { polaco: 'wczoraj', pronunciacion: 'VCHO-ray', traduccion: 'ayer', ejemplo: 'Wczoraj bylo pieknie.' },
    { polaco: 'pojutrze', pronunciacion: 'po-YU-tshe', traduccion: 'pasado manana', ejemplo: 'Pojutrze wyjedziemy.' },
    { polaco: 'przedwczoraj', pronunciacion: 'pshet-VCHO-ray', traduccion: 'anteayer', ejemplo: 'Przedwczoraj przyszedl list.' },
    { polaco: 'teraz', pronunciacion: 'TE-ras', traduccion: 'ahora', ejemplo: 'Teraz nie moge rozmawiac.' },
    { polaco: 'pozniej', pronunciacion: 'POZH-nyey', traduccion: 'despues mas tarde', ejemplo: 'Zadzwonie pozniej.' },
    { polaco: 'wkrotce', pronunciacion: 'VKRUT-se', traduccion: 'pronto en breve', ejemplo: 'Wkrotce bedziemy gotowi.' },
  ]
  const ejercicios = [
    ...
    { pregunta: 'Como se dice ahora en polaco?', opciones: ['pozniej', 'teraz', 'wkrotce', 'wczoraj'], correcta: 'teraz' },
    { pregunta: 'Que significa wczoraj?', opciones: ['manana', 'hoy', 'ayer', 'pasado manana'], correcta: 'ayer' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 46 · Modulo 5</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Hoy ayer y manana</h1>
          <p className="text-gray-500 mt-2">Aprende expresiones de tiempo en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-47" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
