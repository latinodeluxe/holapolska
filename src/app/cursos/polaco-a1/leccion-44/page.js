...
export default function Leccion44() {
  ...
  const vocabulario = [
    { polaco: 'Ktora jest godzina?', pronunciacion: 'KTO-ra yest go-DZI-na', traduccion: 'Que hora es?', ejemplo: 'Przepraszam, ktora jest godzina?' },
    { polaco: 'Jest godzina', pronunciacion: 'yest go-DZI-na', traduccion: 'Son las', ejemplo: 'Jest godzina osma.' },
    { polaco: 'rano', pronunciacion: 'RA-no', traduccion: 'manana temprano', ejemplo: 'Wstaje o szostej rano.' },
    { polaco: 'poludnie', pronunciacion: 'po-WUD-nye', traduccion: 'mediodia', ejemplo: 'Obiad jemy w poludnie.' },
    { polaco: 'popoludnie', pronunciacion: 'po-po-WUD-nye', traduccion: 'tarde', ejemplo: 'Spotkanie jest po poludniu.' },
    { polaco: 'wieczor', pronunciacion: 'VYE-chur', traduccion: 'noche tarde', ejemplo: 'Ogladam telewizje wieczorem.' },
    { polaco: 'noc', pronunciacion: 'nots', traduccion: 'noche madrugada', ejemplo: 'Ide spac o polnocy.' },
    { polaco: 'kwadrans', pronunciacion: 'KVA-drans', traduccion: 'cuarto de hora', ejemplo: 'Przyjde za kwadrans.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se pregunta la hora en polaco?', opciones: ['Jest godzina', 'Ktora jest godzina?', 'rano', 'wieczor'], correcta: 'Ktora jest godzina?' },
    { pregunta: 'Que significa poludnie?', opciones: ['manana', 'tarde', 'mediodia', 'noche'], correcta: 'mediodia' },
    { pregunta: 'Como se dice tarde noche en polaco?', opciones: ['rano', 'noc', 'wieczor', 'poludnie'], correcta: 'wieczor' },
    { pregunta: 'Que significa kwadrans?', opciones: ['media hora', 'cuarto de hora', 'hora', 'minuto'], correcta: 'cuarto de hora' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 44 · Modulo 5</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">La hora</h1>
          <p className="text-gray-500 mt-2">Aprende a decir la hora en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-45" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
