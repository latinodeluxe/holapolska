...
export default function Leccion54() {
  ...
  const vocabulario = [
    { polaco: 'centrum', pronunciacion: 'TSEN-trum', traduccion: 'centro ciudad', ejemplo: 'Mieszkam w centrum Warszawy.' },
    { polaco: 'rynek', pronunciacion: 'RI-nek', traduccion: 'plaza mercado central', ejemplo: 'Rynek Glowny jest piekny.' },
    { polaco: 'park', pronunciacion: 'park', traduccion: 'parque', ejemplo: 'Chodze na spacer do parku.' },
    { polaco: 'kosciol', pronunciacion: 'KO-shchuw', traduccion: 'iglesia', ejemplo: 'Kosciol jest bardzo stary.' },
    { polaco: 'muzeum', pronunciacion: 'mu-ZE-um', traduccion: 'museo', ejemplo: 'Muzeum jest czynne do osiemnastej.' },
    { polaco: 'apteka', pronunciacion: 'ap-TE-ka', traduccion: 'farmacia', ejemplo: 'Apteka jest na rogu ulicy.' },
    { polaco: 'bank', pronunciacion: 'bank', traduccion: 'banco', ejemplo: 'Musze isc do banku.' },
    { polaco: 'poczta', pronunciacion: 'POCH-ta', traduccion: 'correos oficina de correos', ejemplo: 'Wysylam paczke na poczcie.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice parque en polaco?', opciones: ['rynek', 'centrum', 'park', 'kosciol'], correcta: 'park' },
    { pregunta: 'Que significa apteka?', opciones: ['banco', 'museo', 'farmacia', 'correos'], correcta: 'farmacia' },
    { pregunta: 'Como se dice museo en polaco?', opciones: ['bank', 'poczta', 'muzeum', 'apteka'], correcta: 'muzeum' },
    { pregunta: 'Que significa centrum?', opciones: ['plaza', 'parque', 'iglesia', 'centro ciudad'], correcta: 'centro ciudad' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 54 · Modulo 6</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Lugares de la ciudad</h1>
          <p className="text-gray-500 mt-2">Aprende los lugares mas importantes de la ciudad en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-55" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
