...
export default function Leccion43() {
  ...
  const vocabulario = [
    { polaco: 'wrzesien', pronunciacion: 'VZHE-shen', traduccion: 'septiembre', ejemplo: 'Szkola zaczyna sie we wrzesniu.' },
    { polaco: 'pazdziernik', pronunciacion: 'pazh-DZHER-nik', traduccion: 'octubre', ejemplo: 'W pazdzierniku liscie padaja.' },
    { polaco: 'listopad', pronunciacion: 'lis-TO-pat', traduccion: 'noviembre', ejemplo: 'Listopad jest szary i deszczowy.' },
    { polaco: 'grudzien', pronunciacion: 'GRU-dzhen', traduccion: 'diciembre', ejemplo: 'W grudniu sa Boze Narodzenie.' },
    { polaco: 'miesiac', pronunciacion: 'MYE-shyats', traduccion: 'mes', ejemplo: 'Ktory miesiac lubisz najbardziej?' },
    { polaco: 'rok', pronunciacion: 'rok', traduccion: 'año', ejemplo: 'W tym roku duzo sie nauczylem.' },
    { polaco: 'wiosna', pronunciacion: 'VYOS-na', traduccion: 'primavera', ejemplo: 'Wiosna jest moja ulubiona pora roku.' },
    { polaco: 'lato', pronunciacion: 'LA-to', traduccion: 'verano', ejemplo: 'Latem jedziemy nad morze.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice septiembre en polaco?', opciones: ['pazdziernik', 'wrzesien', 'listopad', 'grudzien'], correcta: 'wrzesien' },
    { pregunta: 'Que significa grudzien?', opciones: ['octubre', 'noviembre', 'diciembre', 'enero'], correcta: 'diciembre' },
    { pregunta: 'Como se dice verano en polaco?', opciones: ['wiosna', 'lato', 'rok', 'miesiac'], correcta: 'lato' },
    { pregunta: 'Que significa miesiac?', opciones: ['año', 'semana', 'mes', 'dia'], correcta: 'mes' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 43 · Modulo 5</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Los meses del ano parte 2</h1>
          <p className="text-gray-500 mt-2">Aprende los meses de septiembre a diciembre en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-44" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
