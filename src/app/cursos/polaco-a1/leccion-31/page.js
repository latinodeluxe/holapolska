...
export default function Leccion31() {
  ...
  const vocabulario = [
    { polaco: 'restauracja', pronunciacion: 'res-tau-RAT-sya', traduccion: 'restaurante', ejemplo: 'Idziemy do restauracji na obiad.' },
    { polaco: 'menu', pronunciacion: 'ME-nu', traduccion: 'menu carta', ejemplo: 'Prosze o menu.' },
    { polaco: 'kelner', pronunciacion: 'KEL-ner', traduccion: 'camarero', ejemplo: 'Kelner przyjmuje zamowienie.' },
    { polaco: 'zamowienie', pronunciacion: 'za-mo-VYE-nye', traduccion: 'pedido orden', ejemplo: 'Chce zlozyc zamowienie.' },
    { polaco: 'stolik', pronunciacion: 'STO-lik', traduccion: 'mesa pequeña', ejemplo: 'Czy jest wolny stolik?' },
    { polaco: 'rachunek', pronunciacion: 'ra-HU-nek', traduccion: 'cuenta factura', ejemplo: 'Prosze o rachunek.' },
    { polaco: 'napiwek', pronunciacion: 'na-PI-vek', traduccion: 'propina', ejemplo: 'Zostawiam napiwek.' },
    { polaco: 'rezerwacja', pronunciacion: 're-zer-VAT-sya', traduccion: 'reserva', ejemplo: 'Mam rezerwacje na osma.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice restaurante en polaco?', opciones: ['menu', 'restauracja', 'kelner', 'stolik'], correcta: 'restauracja' },
    { pregunta: 'Que significa rachunek?', opciones: ['menu', 'propina', 'cuenta factura', 'reserva'], correcta: 'cuenta factura' },
    { pregunta: 'Como se dice camarero en polaco?', opciones: ['stolik', 'napiwek', 'kelner', 'menu'], correcta: 'kelner' },
    { pregunta: 'Que significa rezerwacja?', opciones: ['pedido', 'mesa', 'propina', 'reserva'], correcta: 'reserva' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 31 · Modulo 4</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">En el restaurante</h1>
          <p className="text-gray-500 mt-2">Aprende a pedir comida en un restaurante polaco</p>
        </div>
        ...
        {tab === 'vocabulario' && (
cat > src/app/cursos/polaco-a1/leccion-31/page.js << 'EOF'
'use client'
import { useState } from 'react'
export default function Leccion31() {
  const [tab, setTab] = useState('vocabulario')
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-32" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
