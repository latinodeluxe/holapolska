...
export default function Leccion62() {
  ...
  const vocabulario = [
    { polaco: 'boli mnie', pronunciacion: 'BO-li mnye', traduccion: 'me duele', ejemplo: 'Boli mnie glowa od rana.' },
    { polaco: 'goraczka', pronunciacion: 'go-RACH-ka', traduccion: 'fiebre', ejemplo: 'Mam goraczke 38 stopni.' },
    { polaco: 'katar', pronunciacion: 'KA-tar', traduccion: 'resfriado mocos', ejemplo: 'Mam katar i kaszel.' },
    { polaco: 'kaszel', pronunciacion: 'KA-shel', traduccion: 'tos', ejemplo: 'Kaszel nie ustepuje od tygodnia.' },
    { polaco: 'bol brzucha', pronunciacion: 'bul BZHU-ha', traduccion: 'dolor de barriga', ejemplo: 'Mam bol brzucha po obiedzie.' },
    { polaco: 'alergia', pronunciacion: 'a-LER-gya', traduccion: 'alergia', ejemplo: 'Mam alergie na pylek.' },
    { polaco: 'czuje sie zle', pronunciacion: 'CHU-ye she zle', traduccion: 'me siento mal', ejemplo: 'Czuje sie zle od wczoraj.' },
    { polaco: 'jestem chory', pronunciacion: 'YES-tem HO-ri', traduccion: 'estoy enfermo', ejemplo: 'Jestem chory i nie ide do pracy.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice me duele en polaco?', opciones: ['goraczka', 'boli mnie', 'katar', 'kaszel'], correcta: 'boli mnie' },
    { pregunta: 'Que significa goraczka?', opciones: ['tos', 'resfriado', 'fiebre', 'alergia'], correcta: 'fiebre' },
    { pregunta: 'Como se dice estoy enfermo en polaco?', opciones: ['czuje sie zle', 'jestem chory', 'boli mnie', 'mam katar'], correcta: 'jestem chory' },
    { pregunta: 'Que significa kaszel?', opciones: ['fiebre', 'alergia', 'resfriado', 'tos'], correcta: 'tos' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 62 · Modulo 7</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Sintomas y enfermedades</h1>
          <p className="text-gray-500 mt-2">Aprende a hablar de sintomas en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-63" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
