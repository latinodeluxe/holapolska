...
export default function Leccion52() {
  ...
  const vocabulario = [
    { polaco: 'przystanek', pronunciacion: 'pshi-STA-nek', traduccion: 'parada', ejemplo: 'Przystanek jest za rogiem.' },
    { polaco: 'bilet', pronunciacion: 'BI-let', traduccion: 'boleto ticket', ejemplo: 'Kupuje bilet na autobus.' },
    { polaco: 'Gdzie jest przystanek?', pronunciacion: 'GDZHE yest pshi-STA-nek', traduccion: 'Donde esta la parada?', ejemplo: 'Przepraszam, gdzie jest przystanek autobusu?' },
    { polaco: 'Ktory autobus jedzie do...?', pronunciacion: 'KTO-ri au-TO-bus YE-dzhe do', traduccion: 'Cual autobus va a...?', ejemplo: 'Ktory autobus jedzie do centrum?' },
    { polaco: 'nastepny', pronunciacion: 'nas-TEMP-ni', traduccion: 'siguiente proximo', ejemplo: 'Nastepny autobus jest za 5 minut.' },
    { polaco: 'odjazd', pronunciacion: 'OD-yazd', traduccion: 'salida partida', ejemplo: 'Odjazd o godzinie osmej.' },
    { polaco: 'przyjazd', pronunciacion: 'PSHI-yazd', traduccion: 'llegada', ejemplo: 'Przyjazd planowany na dziewiatnastu.' },
    { polaco: 'rozkad jazdy', pronunciacion: 'ROZ-kwat YAZ-di', traduccion: 'horario', ejemplo: 'Sprawdzam rozklad jazdy.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice parada en polaco?', opciones: ['bilet', 'przystanek', 'odjazd', 'przyjazd'], correcta: 'przystanek' },
    { pregunta: 'Que significa bilet?', opciones: ['horario', 'parada', 'boleto ticket', 'llegada'], correcta: 'boleto ticket' },
    { pregunta: 'Como se dice llegada en polaco?', opciones: ['odjazd', 'nastepny', 'przyjazd', 'bilet'], correcta: 'przyjazd' },
    { pregunta: 'Que significa nastepny?', opciones: ['anterior', 'siguiente proximo', 'ultimo', 'primero'], correcta: 'siguiente proximo' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 52 · Modulo 6</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">En el autobus</h1>
          <p className="text-gray-500 mt-2">Aprende a usar el autobus en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-53" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
