...
export default function Leccion24() {
  ...
  const vocabulario = [
    { polaco: 'lodówka', pronunciacion: 'lo-DUV-ka', traduccion: 'refrigerador', ejemplo: 'Wlóz jedzenie do lodówki.' },
    { polaco: 'kuchenka', pronunciacion: 'ku-HEN-ka', traduccion: 'cocina estufa', ejemplo: 'Gotuje na kuchence.' },
    { polaco: 'piekarnik', pronunciacion: 'pye-KAR-nik', traduccion: 'horno', ejemplo: 'Pieke chleb w piekarniku.' },
    { polaco: 'zmywarka', pronunciacion: 'zmi-VAR-ka', traduccion: 'lavaplatos', ejemplo: 'Zmywarka jest zepsuta.' },
    { polaco: 'pralka', pronunciacion: 'PRAL-ka', traduccion: 'lavadora', ejemplo: 'Pralka jest w lazience.' },
    { polaco: 'telewizor', pronunciacion: 'te-le-VI-zor', traduccion: 'television', ejemplo: 'Ogladam telewizor wieczorem.' },
    { polaco: 'komputer', pronunciacion: 'kom-PU-ter', traduccion: 'computadora', ejemplo: 'Pracuje na komputerze.' },
    { polaco: 'telefon', pronunciacion: 'te-LE-fon', traduccion: 'telefono', ejemplo: 'Mój telefon jest nowy.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice refrigerador en polaco?', opciones: ['pralka', 'lodówka', 'kuchenka', 'zmywarka'], correcta: 'lodówka' },
    { pregunta: 'Que significa pralka?', opciones: ['lavaplatos', 'horno', 'lavadora', 'refrigerador'], correcta: 'lavadora' },
    { pregunta: 'Como se dice television en polaco?', opciones: ['komputer', 'telefon', 'telewizor', 'piekarnik'], correcta: 'telewizor' },
    { pregunta: 'Que significa piekarnik?', opciones: ['cocina', 'refrigerador', 'lavaplatos', 'horno'], correcta: 'horno' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 24 · Modulo 3</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Electrodomesticos</h1>
          <p className="text-gray-500 mt-2">Aprende los aparatos del hogar en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-25" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
