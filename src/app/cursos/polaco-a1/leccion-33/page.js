...
export default function Leccion33() {
  ...
  const vocabulario = [
    { polaco: 'woda', pronunciacion: 'VO-da', traduccion: 'agua', ejemplo: 'Prosze szklankę wody.' },
    { polaco: 'kawa', pronunciacion: 'KA-va', traduccion: 'cafe', ejemplo: 'Pije kawe rano.' },
    { polaco: 'herbata', pronunciacion: 'her-BA-ta', traduccion: 'te', ejemplo: 'Herbata z mlekiem jest pyszna.' },
    { polaco: 'sok', pronunciacion: 'sok', traduccion: 'jugo zumo', ejemplo: 'Sok pomaranczowy prosze.' },
    { polaco: 'piwo', pronunciacion: 'PI-vo', traduccion: 'cerveza', ejemplo: 'Piwo jest zimne i dobre.' },
    { polaco: 'wino', pronunciacion: 'VI-no', traduccion: 'vino', ejemplo: 'Czerwone wino do obiadu.' },
    { polaco: 'mleko', pronunciacion: 'MLE-ko', traduccion: 'leche', ejemplo: 'Szklanka mleka przed snem.' },
    { polaco: 'napoj', pronunciacion: 'NA-puy', traduccion: 'bebida refresco', ejemplo: 'Jaki napoj chcesz?' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice agua en polaco?', opciones: ['mleko', 'woda', 'sok', 'kawa'], correcta: 'woda' },
    { pregunta: 'Que significa herbata?', opciones: ['cafe', 'te', 'cerveza', 'vino'], correcta: 'te' },
    { pregunta: 'Como se dice cerveza en polaco?', opciones: ['wino', 'piwo', 'napoj', 'sok'], correcta: 'piwo' },
    { pregunta: 'Que significa sok?', opciones: ['agua', 'leche', 'jugo zumo', 'vino'], correcta: 'jugo zumo' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 33 · Modulo 4</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Bebidas</h1>
          <p className="text-gray-500 mt-2">Aprende las bebidas en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-34" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
