...
export default function Leccion17() {
  ...
  const vocabulario = [
    ...
    { polaco: 'mieszkanie', pronunciacion: 'myesh-KA-nye', traduccion: 'apartamento', ejemplo: 'Mieszkam w mieszkaniu.' },
    { polaco: 'kuchnia', pronunciacion: 'KUCH-nya', traduccion: 'cocina', ejemplo: 'Gotuje w kuchni.' },
    { polaco: 'sypialnia', pronunciacion: 'si-PYAL-nya', traduccion: 'dormitorio', ejemplo: 'Sypialnia jest na gorze.' },
    { polaco: 'lazienka', pronunciacion: 'wa-ZHEN-ka', traduccion: 'bano', ejemplo: 'Lazienka jest czysta.' },
    { polaco: 'salon', pronunciacion: 'SA-lon', traduccion: 'sala de estar', ejemplo: 'Ogladamy telewizje w salonie.' },
    { polaco: 'ogrod', pronunciacion: 'O-grut', traduccion: 'jardin', ejemplo: 'Mamy piekny ogrod.' },
    { polaco: 'garaz', pronunciacion: 'GA-rash', traduccion: 'garaje', ejemplo: 'Samochod jest w garazu.' },
  ]
  const ejercicios = [
    ...
    { pregunta: 'Como se dice apartamento en polaco?', opciones: ['dom', 'ogrod', 'mieszkanie', 'garaz'], correcta: 'mieszkanie' },
    { pregunta: 'Que significa salon?', opciones: ['jardin', 'garaje', 'bano', 'sala de estar'], correcta: 'sala de estar' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 17 · Modulo 2</span>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-18" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
