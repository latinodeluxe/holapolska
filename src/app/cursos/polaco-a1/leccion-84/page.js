...
export default function Leccion84() {
  ...
  const vocabulario = [
    { polaco: 'Chcialbym wyslac paczke', pronunciacion: 'HCHAW-bim VI-swach PACH-ke', traduccion: 'Quisiera enviar un paquete', ejemplo: 'Chcialbym wyslac paczke do Meksyku.' },
    { polaco: 'list', pronunciacion: 'list', traduccion: 'carta', ejemplo: 'Wysylalem list do rodziny.' },
    { polaco: 'paczka', pronunciacion: 'PACH-ka', traduccion: 'paquete', ejemplo: 'Paczka dotarla po trzech dniach.' },
    { polaco: 'znaczek', pronunciacion: 'ZNA-chek', traduccion: 'sello estampilla', ejemplo: 'Prosze znaczek na list do Hiszpanii.' },
    { polaco: 'adres nadawcy', pronunciacion: 'AD-res na-DAV-tsi', traduccion: 'direccion del remitente', ejemplo: 'Prosze podac adres nadawcy.' },
    { polaco: 'adres odbiorcy', pronunciacion: 'AD-res od-BYOR-tsi', traduccion: 'direccion del destinatario', ejemplo: 'Jaki jest adres odbiorcy?' },
    { polaco: 'polecony', pronunciacion: 'po-le-TSO-ni', traduccion: 'certificado con acuse', ejemplo: 'Chce wyslac list polecony.' },
    { polaco: 'czas dostawy', pronunciacion: 'chas dos-TA-vi', traduccion: 'tiempo de entrega', ejemplo: 'Jaki jest czas dostawy do Argentyny?' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice paquete en polaco?', opciones: ['list', 'znaczek', 'paczka', 'polecony'], correcta: 'paczka' },
    { pregunta: 'Que significa znaczek?', opciones: ['carta', 'paquete', 'sello estampilla', 'certificado'], correcta: 'sello estampilla' },
    { pregunta: 'Como se dice carta en polaco?', opciones: ['paczka', 'list', 'znaczek', 'polecony'], correcta: 'list' },
    { pregunta: 'Que significa polecony?', opciones: ['urgente', 'certificado con acuse', 'expres', 'economico'], correcta: 'certificado con acuse' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 84 · Modulo 9</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">En correos</h1>
          <p className="text-gray-500 mt-2">Aprende a enviar cartas y paquetes en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-85" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
