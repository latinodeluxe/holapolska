...
export default function Leccion41() {
  ...
  const vocabulario = [
    { polaco: 'poniedzialek', pronunciacion: 'po-nye-DZHA-wek', traduccion: 'lunes', ejemplo: 'W poniedzialek ide do pracy.' },
    { polaco: 'wtorek', pronunciacion: 'VTO-rek', traduccion: 'martes', ejemplo: 'We wtorek mam spotkanie.' },
    { polaco: 'sroda', pronunciacion: 'SHRO-da', traduccion: 'miercoles', ejemplo: 'W srode ide na silownie.' },
    { polaco: 'czwartek', pronunciacion: 'CHVAR-tek', traduccion: 'jueves', ejemplo: 'W czwartek mam wolne.' },
    { polaco: 'piatek', pronunciacion: 'PYA-tek', traduccion: 'viernes', ejemplo: 'W piatek wychodzimy z przyjaciolmi.' },
    { polaco: 'sobota', pronunciacion: 'so-BO-ta', traduccion: 'sabado', ejemplo: 'W sobote sypiam dluzej.' },
    { polaco: 'niedziela', pronunciacion: 'nye-DZHE-la', traduccion: 'domingo', ejemplo: 'W niedziele odwiedzamy rodzine.' },
    { polaco: 'tydzien', pronunciacion: 'TI-dzhen', traduccion: 'semana', ejemplo: 'Ten tydzien jest bardzo pracowity.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice lunes en polaco?', opciones: ['wtorek', 'poniedzialek', 'sroda', 'czwartek'], correcta: 'poniedzialek' },
    { pregunta: 'Que significa piatek?', opciones: ['jueves', 'sabado', 'viernes', 'domingo'], correcta: 'viernes' },
    { pregunta: 'Como se dice domingo en polaco?', opciones: ['sobota', 'niedziela', 'tydzien', 'sroda'], correcta: 'niedziela' },
    { pregunta: 'Que significa tydzien?', opciones: ['dia', 'mes', 'semana', 'año'], correcta: 'semana' },
    { pregunta: 'Como se dice miercoles en polaco?', opciones: ['wtorek', 'czwartek', 'sroda', 'piatek'], correcta: 'sroda' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 41 · Modulo 5</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Los dias de la semana</h1>
          <p className="text-gray-500 mt-2">Aprende los dias de la semana en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-42" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
