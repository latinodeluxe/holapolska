...
export default function Leccion68() {
  ...
  const vocabulario = [
    { polaco: 'szczesliwy', pronunciacion: 'shches-LI-vi', traduccion: 'feliz contento', ejemplo: 'Jestem szczesliwy z zycia.' },
    { polaco: 'smutny', pronunciacion: 'SMUT-ni', traduccion: 'triste', ejemplo: 'Dlaczego jestes smutny?' },
    { polaco: 'zmeczony', pronunciacion: 'zmen-CHO-ni', traduccion: 'cansado agotado', ejemplo: 'Jestem bardzo zmeczony po pracy.' },
    { polaco: 'zestresowany', pronunciacion: 'zes-tre-SO-va-ni', traduccion: 'estresado', ejemplo: 'Jestem zestresowany przed egzaminem.' },
    { polaco: 'spokojny', pronunciacion: 'spo-KOY-ni', traduccion: 'tranquilo calmado', ejemplo: 'Staram sie byc spokojny.' },
    { polaco: 'sen', pronunciacion: 'sen', traduccion: 'sueno dormir', ejemplo: 'Potrzebuje dobrego snu.' },
    { polaco: 'relaks', pronunciacion: 'RE-laks', traduccion: 'relajacion', ejemplo: 'Joga pomaga mi sie zrelaksowac.' },
    { polaco: 'stres', pronunciacion: 'stres', traduccion: 'estres', ejemplo: 'Stres jest szkodliwy dla zdrowia.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice feliz en polaco?', opciones: ['smutny', 'zmeczony', 'szczesliwy', 'spokojny'], correcta: 'szczesliwy' },
    { pregunta: 'Que significa zmeczony?', opciones: ['triste', 'feliz', 'cansado agotado', 'estresado'], correcta: 'cansado agotado' },
    { pregunta: 'Como se dice tranquilo en polaco?', opciones: ['stres', 'relaks', 'spokojny', 'sen'], correcta: 'spokojny' },
    { pregunta: 'Que significa stres?', opciones: ['sueno', 'relajacion', 'tranquilidad', 'estres'], correcta: 'estres' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 68 · Modulo 7</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Bienestar y emociones</h1>
          <p className="text-gray-500 mt-2">Aprende a expresar emociones en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-69" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
