...
export default function Leccion59() {
  ...
  const vocabulario = [
    { polaco: 'Chcialbym pojechac do', pronunciacion: 'HCHAW-bim po-YE-hach do', traduccion: 'Me gustaria ir a', ejemplo: 'Chcialbym pojechac do Krakowa.' },
    { polaco: 'Jak daleko jest...?', pronunciacion: 'yak da-LE-ko yest', traduccion: 'Que tan lejos esta...?', ejemplo: 'Jak daleko jest do Gdanska?' },
    { polaco: 'ile czasu zajmie?', pronunciacion: 'EE-le CHA-su ZAY-mye', traduccion: 'cuanto tiempo tarda?', ejemplo: 'Ile czasu zajmie droga do Warszawy?' },
    { polaco: 'polecam', pronunciacion: 'po-LE-tsam', traduccion: 'recomiendo', ejemplo: 'Polecam odwiedzic Wawel w Krakowie.' },
    { polaco: 'warto', pronunciacion: 'VAR-to', traduccion: 'vale la pena', ejemplo: 'Warto pojechac do Zakopanego.' },
    { polaco: 'piekne miejsce', pronunciacion: 'PYEK-ne MYEYS-tse', traduccion: 'lugar bonito', ejemplo: 'To jest naprawde piekne miejsce.' },
    { polaco: 'zwiedzac', pronunciacion: 'ZVYE-dzach', traduccion: 'visitar recorrer', ejemplo: 'Lubie zwiedzac nowe miejsca.' },
    { polaco: 'wakacje', pronunciacion: 'va-KA-tsye', traduccion: 'vacaciones', ejemplo: 'W tym roku jade na wakacje do Italii.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice vacaciones en polaco?', opciones: ['wycieczka', 'wakacje', 'zwiedzac', 'warto'], correcta: 'wakacje' },
    { pregunta: 'Que significa polecam?', opciones: ['vale la pena', 'recomiendo', 'visitar', 'me gustaria'], correcta: 'recomiendo' },
    { pregunta: 'Como se dice visitar recorrer en polaco?', opciones: ['wakacje', 'warto', 'zwiedzac', 'polecam'], correcta: 'zwiedzac' },
    { pregunta: 'Que significa warto?', opciones: ['recomiendo', 'visitar', 'vale la pena', 'vacaciones'], correcta: 'vale la pena' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 59 · Modulo 6</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Hablar de viajes</h1>
          <p className="text-gray-500 mt-2">Aprende a conversar sobre viajes en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-60" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
