...
export default function Leccion16() {
  ...
  const vocabulario = [
    { polaco: 'stol', pronunciacion: 'stow', traduccion: 'mesa', ejemplo: 'Stol jest w kuchni.' },
    { polaco: 'krzeslo', pronunciacion: 'KSHEZ-wo', traduccion: 'silla', ejemplo: 'Siedze na krzesle.' },
    { polaco: 'lozko', pronunciacion: 'WOZH-ko', traduccion: 'cama', ejemplo: 'Ide spac do lozka.' },
    { polaco: 'sofa', pronunciacion: 'SO-fa', traduccion: 'sofa', ejemplo: 'Ogladam telewizje na sofie.' },
    { polaco: 'okno', pronunciacion: 'OK-no', traduccion: 'ventana', ejemplo: 'Otworz okno, prosze.' },
    { polaco: 'drzwi', pronunciacion: 'DZHVI', traduccion: 'puerta', ejemplo: 'Zamknij drzwi.' },
    { polaco: 'szafa', pronunciacion: 'SHA-fa', traduccion: 'armario', ejemplo: 'Ubrana sa w szafie.' },
    { polaco: 'lampa', pronunciacion: 'LAM-pa', traduccion: 'lampara', ejemplo: 'Wlacz lampe, jest ciemno.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice mesa en polaco?', opciones: ['krzeslo', 'stol', 'lozko', 'sofa'], correcta: 'stol' },
    { pregunta: 'Que significa okno?', opciones: ['puerta', 'ventana', 'armario', 'lampara'], correcta: 'ventana' },
    { pregunta: 'Como se dice cama en polaco?', opciones: ['sofa', 'szafa', 'lozko', 'stol'], correcta: 'lozko' },
    { pregunta: 'Que significa drzwi?', opciones: ['ventana', 'puerta', 'silla', 'mesa'], correcta: 'puerta' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 16 · Modulo 2</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Objetos del hogar</h1>
          <p className="text-gray-500 mt-2">Aprende los muebles y objetos del hogar en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-17" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
