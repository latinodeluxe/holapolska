...
export default function Leccion45() {
  ...
  const vocabulario = [
    { polaco: 'wstawac', pronunciacion: 'vsta-VACH', traduccion: 'levantarse', ejemplo: 'Wstaje o siodmej rano.' },
    { polaco: 'myc zeby', pronunciacion: 'mich ZE-bi', traduccion: 'lavarse los dientes', ejemplo: 'Myje zeby dwa razy dziennie.' },
    { polaco: 'brac prysznic', pronunciacion: 'brach PRISH-nits', traduccion: 'ducharse', ejemplo: 'Biore prysznic rano.' },
    { polaco: 'ubierac sie', pronunciacion: 'u-BYE-rach she', traduccion: 'vestirse', ejemplo: 'Ubieram sie szybko.' },
    { polaco: 'jesc sniadanie', pronunciacion: 'yeshch shnya-DA-nye', traduccion: 'desayunar', ejemplo: 'Jem sniadanie o osmej.' },
    { polaco: 'isc do pracy', pronunciacion: 'eeshch do PRA-tsi', traduccion: 'ir al trabajo', ejemplo: 'Ide do pracy o dziewiatej.' },
    { polaco: 'wracac do domu', pronunciacion: 'vra-TSACH do DO-mu', traduccion: 'volver a casa', ejemplo: 'Wracam do domu o siedemnastej.' },
    { polaco: 'isc spac', pronunciacion: 'eeshch spach', traduccion: 'irse a dormir', ejemplo: 'Ide spac o dwudziestej trzeciej.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice levantarse en polaco?', opciones: ['isc spac', 'wstawac', 'ubierac sie', 'brac prysznic'], correcta: 'wstawac' },
    { pregunta: 'Que significa jesc sniadanie?', opciones: ['almorzar', 'cenar', 'desayunar', 'merendar'], correcta: 'desayunar' },
    { pregunta: 'Como se dice ducharse en polaco?', opciones: ['myc zeby', 'wstawac', 'brac prysznic', 'ubierac sie'], correcta: 'brac prysznic' },
    { pregunta: 'Que significa wracac do domu?', opciones: ['ir al trabajo', 'volver a casa', 'irse a dormir', 'levantarse'], correcta: 'volver a casa' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 45 · Modulo 5</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Rutinas diarias</h1>
          <p className="text-gray-500 mt-2">Aprende a hablar de tu rutina diaria en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-46" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
