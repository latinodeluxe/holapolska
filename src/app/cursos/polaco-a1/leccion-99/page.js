...
export default function Leccion99() {
  const [tab, setTab] = useState('repaso')
  const [respuestas, setRespuestas] = useState({})
  const [mostrarResultado, setMostrarResultado] = useState(false)
  const repaso = [
    { categoria: 'Conversaciones', frases: [
      { polaco: 'Szukam / Wezme to', pronunciacion: 'SHU-kam / VEZH-me to', traduccion: 'Busco / Me lo llevo' },
      { polaco: 'Zgadzam sie / Oczywiście', pronunciacion: 'zga-DZAM she / o-chi-VISH-che', traduccion: 'Estoy de acuerdo / Por supuesto' },
    ]},
  ]
  const examen = [
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 99 · Modulo 10</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Repaso conversaciones reales</h1>
          <p className="text-gray-500 mt-2">Repasa el Modulo 9</p>
        </div>
          ...
          <div>
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <a href="/cursos/polaco-a1/leccion-100" className="inline-block mt-6 px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Ir al examen final</a>
              </div>
            )}
          </div>
        )}
