...
export default function Leccion12() {
  ...
  const vocabulario = [
    { polaco: 'zona', pronunciacion: 'ZHO-na', traduccion: 'esposa', ejemplo: 'Moja zona ma na imie Maria.' },
    { polaco: 'maz', pronunciacion: 'mozh', traduccion: 'esposo', ejemplo: 'Moj maz jest inzynierem.' },
    { polaco: 'corka', pronunciacion: 'TSUR-ka', traduccion: 'hija', ejemplo: 'Moja corka ma piec lat.' },
    { polaco: 'wujek', pronunciacion: 'VU-yek', traduccion: 'tio', ejemplo: 'Moj wujek mieszka w Warszawie.' },
    { polaco: 'ciocia', pronunciacion: 'CHO-cha', traduccion: 'tia', ejemplo: 'Moja ciocia gotuje pyszne jedzenie.' },
    { polaco: 'kuzyn', pronunciacion: 'KU-zin', traduccion: 'primo', ejemplo: 'Moj kuzyn studiuje medycyne.' },
    { polaco: 'przyjaciel', pronunciacion: 'pshi-YA-chel', traduccion: 'amigo', ejemplo: 'Moj przyjaciel jest z Polski.' },
    { polaco: 'sasiad', pronunciacion: 'SOM-shyad', traduccion: 'vecino', ejemplo: 'Moj sasiad jest bardzo mily.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice esposa en polaco?', opciones: ['maz', 'zona', 'corka', 'ciocia'], correcta: 'zona' },
    { pregunta: 'Que significa corka?', opciones: ['hijo', 'hija', 'tia', 'prima'], correcta: 'hija' },
    { pregunta: 'Como se dice tio en polaco?', opciones: ['ciocia', 'kuzyn', 'wujek', 'sasiad'], correcta: 'wujek' },
    { pregunta: 'Que significa przyjaciel?', opciones: ['vecino', 'primo', 'amigo', 'esposo'], correcta: 'amigo' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 12 · Modulo 2</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Mas miembros de la familia</h1>
          <p className="text-gray-500 mt-2">Amplia tu vocabulario familiar en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-13" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
