...
export default function Leccion19() {
  ...
  const vocabulario = [
    { polaco: 'polski', pronunciacion: 'POL-ski', traduccion: 'polaco', ejemplo: 'On jest Polakiem.' },
    { polaco: 'hiszpanski', pronunciacion: 'hish-PAN-ski', traduccion: 'espanol', ejemplo: 'Ona jest Hiszpanka.' },
    { polaco: 'meksykanski', pronunciacion: 'mek-si-KAN-ski', traduccion: 'mexicano', ejemplo: 'Jestem Meksykaninem.' },
    { polaco: 'argentynski', pronunciacion: 'ar-gen-TIN-ski', traduccion: 'argentino', ejemplo: 'On jest Argentynczykiem.' },
    { polaco: 'niemiecki', pronunciacion: 'nye-MYETS-ki', traduccion: 'aleman', ejemplo: 'Ona mowi po niemiecku.' },
    { polaco: 'francuski', pronunciacion: 'fran-TSUS-ki', traduccion: 'frances', ejemplo: 'Lubie jezyk francuski.' },
    { polaco: 'jezyk', pronunciacion: 'YE-zik', traduccion: 'idioma', ejemplo: 'Ucze sie jezyka polskiego.' },
    { polaco: 'mowic', pronunciacion: 'MO-vich', traduccion: 'hablar', ejemplo: 'Mowisz po polsku?' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice polaco como adjetivo en polaco?', opciones: ['hiszpanski', 'polski', 'niemiecki', 'francuski'], correcta: 'polski' },
    { pregunta: 'Que significa jezyk?', opciones: ['pais', 'idioma', 'hablar', 'aprender'], correcta: 'idioma' },
    { pregunta: 'Como se dice hablar en polaco?', opciones: ['mowic', 'jezyk', 'polski', 'uczuc'], correcta: 'mowic' },
    { pregunta: 'Que significa niemiecki?', opciones: ['frances', 'espanol', 'aleman', 'polaco'], correcta: 'aleman' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 19 · Modulo 2</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Nacionalidades e idiomas</h1>
          <p className="text-gray-500 mt-2">Aprende a hablar de nacionalidades en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-20" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
