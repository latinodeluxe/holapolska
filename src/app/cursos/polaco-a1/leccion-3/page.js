...
export default function Leccion3() {
  ...
  const vocabulario = [
    { polaco: 'Skad jestes?', pronunciacion: 'skont YES-tesh', traduccion: 'De donde eres?', ejemplo: 'Skad jestes? Jestem z Hiszpanii.' },
    { polaco: 'Jestem z', pronunciacion: 'YES-tem z', traduccion: 'Soy de', ejemplo: 'Jestem z Meksyku.' },
    { polaco: 'Polska', pronunciacion: 'POL-ska', traduccion: 'Polonia', ejemplo: 'Jestem z Polski.' },
    { polaco: 'Hiszpania', pronunciacion: 'hish-PA-nya', traduccion: 'Espana', ejemplo: 'Ona jest z Hiszpanii.' },
    { polaco: 'Meksyk', pronunciacion: 'MEK-sik', traduccion: 'Mexico', ejemplo: 'Jestem z Meksyku.' },
    { polaco: 'Argentyna', pronunciacion: 'ar-gen-TI-na', traduccion: 'Argentina', ejemplo: 'On jest z Argentyny.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice "De donde eres?" en polaco?', opciones: ['Jestem z', 'Skad jestes?', 'Jak sie nazywasz?', 'Milo mi'], correcta: 'Skad jestes?' },
    { pregunta: 'Que significa "Jestem z Polski"?', opciones: ['Soy de Mexico', 'Soy de Espana', 'Soy de Polonia', 'Soy de Argentina'], correcta: 'Soy de Polonia' },
    { pregunta: 'Como se dice "Mexico" en polaco?', opciones: ['Polska', 'Hiszpania', 'Argentyna', 'Meksyk'], correcta: 'Meksyk' },
    { pregunta: 'Que significa "Hiszpania"?', opciones: ['Polonia', 'Mexico', 'Espana', 'Argentina'], correcta: 'Espana' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 3 · Modulo 1</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">De donde eres</h1>
          <p className="text-gray-500 mt-2">Aprende a decir tu pais de origen en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-4" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
