...
export default function Leccion6() {
  ...
  const vocabulario = [
    { polaco: 'jestem', pronunciacion: 'YES-tem', traduccion: 'yo soy / estoy', ejemplo: 'Jestem studentem.' },
    { polaco: 'jestes', pronunciacion: 'YES-tesh', traduccion: 'tu eres / estas', ejemplo: 'Jestes bardzo mily.' },
    { polaco: 'jest', pronunciacion: 'yest', traduccion: 'el/ella es / esta', ejemplo: 'On jest lekarzem.' },
    { polaco: 'jestesmy', pronunciacion: 'yes-TESH-mi', traduccion: 'nosotros somos', ejemplo: 'Jestesmy z Polski.' },
    { polaco: 'jestescie', pronunciacion: 'yes-TESH-che', traduccion: 'vosotros sois', ejemplo: 'Jestescie studentami.' },
    { polaco: 'sa', pronunciacion: 'som', traduccion: 'ellos son', ejemplo: 'Oni sa z Meksyku.' },
    { polaco: 'student', pronunciacion: 'STOO-dent', traduccion: 'estudiante', ejemplo: 'Jestem studentem.' },
    { polaco: 'lekarz', pronunciacion: 'LE-kazh', traduccion: 'medico', ejemplo: 'On jest lekarzem.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice "yo soy" en polaco?', opciones: ['jest', 'jestes', 'jestem', 'sa'], correcta: 'jestem' },
    { pregunta: 'Que significa "jestes"?', opciones: ['yo soy', 'tu eres', 'el es', 'ellos son'], correcta: 'tu eres' },
    { pregunta: 'Como se dice "ellos son" en polaco?', opciones: ['jest', 'jestesmy', 'jestescie', 'sa'], correcta: 'sa' },
    { pregunta: 'Que significa "lekarz"?', opciones: ['estudiante', 'medico', 'profesor', 'amigo'], correcta: 'medico' },
    { pregunta: 'Como se dice "nosotros somos" en polaco?', opciones: ['jestescie', 'jestesmy', 'jestem', 'jestes'], correcta: 'jestesmy' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 6 · Modulo 1</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">El verbo ser</h1>
          <p className="text-gray-500 mt-2">Aprende a conjugar el verbo ser en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-7" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
