...
export default function Leccion23() {
  ...
  const vocabulario = [
    { polaco: 'okno', pronunciacion: 'OK-no', traduccion: 'ventana', ejemplo: 'Otworz okno, jest duszno.' },
    { polaco: 'drzwi', pronunciacion: 'DZHVI', traduccion: 'puerta', ejemplo: 'Zamknij drzwi, prosze.' },
    { polaco: 'podloga', pronunciacion: 'pod-WO-ga', traduccion: 'piso suelo', ejemplo: 'Podloga jest z drewna.' },
    { polaco: 'sufit', pronunciacion: 'SU-fit', traduccion: 'techo', ejemplo: 'Sufit jest bialy.' },
    { polaco: 'sciana', pronunciacion: 'SHCHA-na', traduccion: 'pared', ejemplo: 'Sciana jest pomalowana na zielono.' },
    { polaco: 'balkon', pronunciacion: 'BAL-kon', traduccion: 'balcon', ejemplo: 'Pijemy kawe na balkonie.' },
    { polaco: 'ogród', pronunciacion: 'O-grut', traduccion: 'jardin', ejemplo: 'Mamy piekny ogród za domem.' },
    { polaco: 'garaz', pronunciacion: 'GA-rash', traduccion: 'garaje', ejemplo: 'Samochód stoi w garazu.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice ventana en polaco?', opciones: ['drzwi', 'okno', 'sufit', 'sciana'], correcta: 'okno' },
    { pregunta: 'Que significa podloga?', opciones: ['techo', 'pared', 'piso suelo', 'balcon'], correcta: 'piso suelo' },
    { pregunta: 'Como se dice jardin en polaco?', opciones: ['garaz', 'balkon', 'ogród', 'sufit'], correcta: 'ogród' },
    { pregunta: 'Que significa drzwi?', opciones: ['ventana', 'puerta', 'pared', 'techo'], correcta: 'puerta' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 23 · Modulo 3</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Partes de la casa</h1>
          <p className="text-gray-500 mt-2">Aprende ventanas puertas y mas en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-24" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
