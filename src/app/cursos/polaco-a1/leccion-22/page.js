...
export default function Leccion22() {
  ...
  const vocabulario = [
    { polaco: 'stól', pronunciacion: 'stul', traduccion: 'mesa', ejemplo: 'Stól jest w kuchni.' },
    { polaco: 'krzeslo', pronunciacion: 'KSHE-swo', traduccion: 'silla', ejemplo: 'Siedze na krzesle.' },
    { polaco: 'lózko', pronunciacion: 'WUZH-ko', traduccion: 'cama', ejemplo: 'Ide spac do lózka.' },
    { polaco: 'sofa', pronunciacion: 'SO-fa', traduccion: 'sofa', ejemplo: 'Ogladam telewizje na sofie.' },
    { polaco: 'szafa', pronunciacion: 'SHA-fa', traduccion: 'armario', ejemplo: 'Ubrana sa w szafie.' },
    { polaco: 'biurko', pronunciacion: 'BYUR-ko', traduccion: 'escritorio', ejemplo: 'Pracuje przy biurku.' },
    { polaco: 'lustro', pronunciacion: 'LUS-tro', traduccion: 'espejo', ejemplo: 'Lustro jest w lazience.' },
    { polaco: 'dywan', pronunciacion: 'DI-van', traduccion: 'alfombra', ejemplo: 'Mamy piekny dywan w salonie.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice mesa en polaco?', opciones: ['krzeslo', 'stól', 'lózko', 'sofa'], correcta: 'stól' },
    { pregunta: 'Que significa szafa?', opciones: ['espejo', 'escritorio', 'armario', 'alfombra'], correcta: 'armario' },
    { pregunta: 'Como se dice cama en polaco?', opciones: ['sofa', 'biurko', 'lózko', 'dywan'], correcta: 'lózko' },
    { pregunta: 'Que significa lustro?', opciones: ['alfombra', 'espejo', 'silla', 'mesa'], correcta: 'espejo' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 22 · Modulo 3</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Muebles del hogar</h1>
          <p className="text-gray-500 mt-2">Aprende los muebles en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-23" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
