...
export default function Leccion5() {
  ...
  const vocabulario = [
    { polaco: 'ja', pronunciacion: 'ya', traduccion: 'yo', ejemplo: 'Ja jestem Carlos.' },
    { polaco: 'ty', pronunciacion: 'ti', traduccion: 'tu', ejemplo: 'Ty jestes z Polski?' },
    { polaco: 'on', pronunciacion: 'on', traduccion: 'el', ejemplo: 'On jest lekarzem.' },
    { polaco: 'ona', pronunciacion: 'O-na', traduccion: 'ella', ejemplo: 'Ona jest nauczycielka.' },
    { polaco: 'my', pronunciacion: 'mi', traduccion: 'nosotros', ejemplo: 'My jestesmy z Meksyku.' },
    { polaco: 'wy', pronunciacion: 'vi', traduccion: 'vosotros', ejemplo: 'Wy jestescie studentami.' },
    { polaco: 'oni', pronunciacion: 'O-ni', traduccion: 'ellos', ejemplo: 'Oni sa z Argentyny.' },
    { polaco: 'one', pronunciacion: 'O-ne', traduccion: 'ellas', ejemplo: 'One sa bardzo mile.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice "yo" en polaco?', opciones: ['ty', 'ja', 'on', 'my'], correcta: 'ja' },
    { pregunta: 'Que significa "ona"?', opciones: ['el', 'ella', 'nosotros', 'ellas'], correcta: 'ella' },
    { pregunta: 'Como se dice "nosotros" en polaco?', opciones: ['wy', 'oni', 'my', 'one'], correcta: 'my' },
    { pregunta: 'Que significa "oni"?', opciones: ['ellas', 'vosotros', 'ellos', 'nosotros'], correcta: 'ellos' },
    { pregunta: 'Como se dice "tu" en polaco?', opciones: ['ja', 'ty', 'on', 'wy'], correcta: 'ty' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 5 · Modulo 1</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Pronombres personales</h1>
          <p className="text-gray-500 mt-2">Aprende los pronombres en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-6" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
