...
export default function Leccion48() {
  ...
  const vocabulario = [
    { polaco: 'pogoda', pronunciacion: 'po-GO-da', traduccion: 'clima tiempo', ejemplo: 'Jaka jest dzisiaj pogoda?' },
    { polaco: 'slonecznie', pronunciacion: 'swo-NECH-nye', traduccion: 'soleado', ejemplo: 'Dzisiaj jest slonecznie i cieplo.' },
    { polaco: 'deszczowo', pronunciacion: 'desh-CHO-vo', traduccion: 'lluvioso', ejemplo: 'Jutro bedzie deszczowo.' },
    { polaco: 'zimno', pronunciacion: 'ZIM-no', traduccion: 'frio', ejemplo: 'Jest bardzo zimno dzisiaj.' },
    { polaco: 'cieplo', pronunciacion: 'CHEP-wo', traduccion: 'calor calido', ejemplo: 'W lipcu jest bardzo cieplo.' },
    { polaco: 'wietrznie', pronunciacion: 'VYET-zhnie', traduccion: 'ventoso', ejemplo: 'Na dworze jest wietrznie.' },
    { polaco: 'snieg', pronunciacion: 'shnyek', traduccion: 'nieve', ejemplo: 'Pada snieg w grudniu.' },
    { polaco: 'deszcz', pronunciacion: 'deshch', traduccion: 'lluvia', ejemplo: 'Nie lubie deszczu.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice clima en polaco?', opciones: ['snieg', 'deszcz', 'pogoda', 'zimno'], correcta: 'pogoda' },
    { pregunta: 'Que significa slonecznie?', opciones: ['lluvioso', 'frio', 'soleado', 'ventoso'], correcta: 'soleado' },
    { pregunta: 'Como se dice nieve en polaco?', opciones: ['deszcz', 'snieg', 'zimno', 'cieplo'], correcta: 'snieg' },
    { pregunta: 'Que significa deszczowo?', opciones: ['soleado', 'frio', 'ventoso', 'lluvioso'], correcta: 'lluvioso' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 48 · Modulo 5</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">El tiempo atmosferico</h1>
          <p className="text-gray-500 mt-2">Aprende a hablar del clima en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-49" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
