...
export default function Leccion21() {
  ...
  const vocabulario = [
    { polaco: 'dom', pronunciacion: 'dom', traduccion: 'casa', ejemplo: 'Moj dom jest duzy.' },
    { polaco: 'mieszkanie', pronunciacion: 'myesh-KA-nye', traduccion: 'apartamento', ejemplo: 'Mieszkam w mieszkaniu na trzecim pietrze.' },
    { polaco: 'pokój', pronunciacion: 'PO-kuy', traduccion: 'habitacion', ejemplo: 'Mam trzy pokoje w domu.' },
    { polaco: 'kuchnia', pronunciacion: 'KUCH-nya', traduccion: 'cocina', ejemplo: 'Gotuje obiad w kuchni.' },
    { polaco: 'lazienka', pronunciacion: 'wa-ZHEN-ka', traduccion: 'bano', ejemplo: 'Lazienka jest na lewo.' },
    { polaco: 'salon', pronunciacion: 'SA-lon', traduccion: 'sala', ejemplo: 'Ogladamy filmy w salonie.' },
    { polaco: 'sypialnia', pronunciacion: 'si-PYAL-nya', traduccion: 'dormitorio', ejemplo: 'Sypialnia jest na górze.' },
    { polaco: 'przedpokój', pronunciacion: 'pshed-PO-kuy', traduccion: 'entrada', ejemplo: 'Buty zostaw w przedpokoju.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice cocina en polaco?', opciones: ['salon', 'kuchnia', 'lazienka', 'sypialnia'], correcta: 'kuchnia' },
    { pregunta: 'Que significa lazienka?', opciones: ['cocina', 'dormitorio', 'bano', 'salon'], correcta: 'bano' },
    { pregunta: 'Como se dice apartamento en polaco?', opciones: ['dom', 'pokój', 'mieszkanie', 'salon'], correcta: 'mieszkanie' },
    { pregunta: 'Que significa sypialnia?', opciones: ['sala', 'entrada', 'bano', 'dormitorio'], correcta: 'dormitorio' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 21 · Modulo 3</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">La casa y las habitaciones</h1>
          <p className="text-gray-500 mt-2">Aprende las partes de la casa en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-22" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
