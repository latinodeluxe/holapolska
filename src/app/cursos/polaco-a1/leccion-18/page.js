...
export default function Leccion18() {
  ...
  const vocabulario = [
    { polaco: 'chleb', pronunciacion: 'hleb', traduccion: 'pan', ejemplo: 'Kupuje chleb w piekarni.' },
    { polaco: 'mleko', pronunciacion: 'MLE-ko', traduccion: 'leche', ejemplo: 'Pije mleko rano.' },
    { polaco: 'jajko', pronunciacion: 'YAY-ko', traduccion: 'huevo', ejemplo: 'Jedze jajko na sniadanie.' },
    { polaco: 'ser', pronunciacion: 'ser', traduccion: 'queso', ejemplo: 'Lubie ser zolty.' },
    { polaco: 'mieso', pronunciacion: 'MYEN-so', traduccion: 'carne', ejemplo: 'Gotuje mieso na obiad.' },
    { polaco: 'ryba', pronunciacion: 'RI-ba', traduccion: 'pescado', ejemplo: 'Jedze ryby w piatek.' },
    { polaco: 'warzywa', pronunciacion: 'va-ZHI-va', traduccion: 'verduras', ejemplo: 'Warzywa sa zdrowe.' },
    { polaco: 'owoce', pronunciacion: 'o-VO-tse', traduccion: 'frutas', ejemplo: 'Lubie jesc owoce.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice pan en polaco?', opciones: ['mleko', 'chleb', 'jajko', 'ser'], correcta: 'chleb' },
    { pregunta: 'Que significa ryba?', opciones: ['carne', 'queso', 'pescado', 'leche'], correcta: 'pescado' },
    { pregunta: 'Como se dice verduras en polaco?', opciones: ['owoce', 'mieso', 'warzywa', 'ser'], correcta: 'warzywa' },
    { pregunta: 'Que significa mleko?', opciones: ['pan', 'leche', 'huevo', 'queso'], correcta: 'leche' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 18 · Modulo 2</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Comida basica</h1>
          <p className="text-gray-500 mt-2">Aprende el vocabulario de alimentos basicos en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-19" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
