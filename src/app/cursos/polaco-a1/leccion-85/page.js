...
export default function Leccion85() {
  ...
  const vocabulario = [
    { polaco: 'impreza', pronunciacion: 'im-PRE-za', traduccion: 'fiesta evento', ejemplo: 'Idziemy na impreze w sobote.' },
    { polaco: 'urodziny', pronunciacion: 'u-ro-DZI-ni', traduccion: 'cumpleanos', ejemplo: 'Jutro sa urodziny Marka.' },
    { polaco: 'Wszystkiego najlepszego', pronunciacion: 'vshist-KYE-go nay-LEP-she-go', traduccion: 'Feliz cumpleanos', ejemplo: 'Wszystkiego najlepszego Aniu!' },
    { polaco: 'Toast', pronunciacion: 'tost', traduccion: 'brindis', ejemplo: 'Wzniesc toast za zdrowie solenizanta.' },
    { polaco: 'Na zdrowie', pronunciacion: 'na ZDRO-vye', traduccion: 'Salud a tu salud', ejemplo: 'Na zdrowie! Za nasz sukces!' },
    { polaco: 'Baw sie dobrze', pronunciacion: 'bav she DOB-zhe', traduccion: 'Pasatela bien', ejemplo: 'Idz na impreze i baw sie dobrze!' },
    { polaco: 'prezent', pronunciacion: 'PRE-zent', traduccion: 'regalo', ejemplo: 'Kupilem piekny prezent urodzinowy.' },
    { polaco: 'tort', pronunciacion: 'tort', traduccion: 'torta pastel', ejemplo: 'Tort czekoladowy jest pyszny.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice fiesta en polaco?', opciones: ['tort', 'impreza', 'prezent', 'toast'], correcta: 'impreza' },
    { pregunta: 'Que significa Na zdrowie?', opciones: ['Feliz cumpleanos', 'Pasatela bien', 'Salud a tu salud', 'Brindis'], correcta: 'Salud a tu salud' },
    { pregunta: 'Como se dice regalo en polaco?', opciones: ['tort', 'toast', 'prezent', 'impreza'], correcta: 'prezent' },
    { pregunta: 'Que significa Baw sie dobrze?', opciones: ['Salud', 'Feliz cumpleanos', 'Pasatela bien', 'Brindis'], correcta: 'Pasatela bien' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 85 · Modulo 9</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">En una fiesta</h1>
          <p className="text-gray-500 mt-2">Aprende frases para fiestas y celebraciones en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-86" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
