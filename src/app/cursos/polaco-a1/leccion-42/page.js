...
export default function Leccion42() {
  ...
  const vocabulario = [
    { polaco: 'styczen', pronunciacion: 'STI-chen', traduccion: 'enero', ejemplo: 'Styczen jest najzimniejszym miesiacem.' },
    { polaco: 'luty', pronunciacion: 'LU-ti', traduccion: 'febrero', ejemplo: 'W lutym sa walentynki.' },
    { polaco: 'marzec', pronunciacion: 'MA-zhets', traduccion: 'marzo', ejemplo: 'Wiosna zaczyna sie w marcu.' },
    { polaco: 'kwiecien', pronunciacion: 'KVYE-chen', traduccion: 'abril', ejemplo: 'W kwietniu kwitna kwiaty.' },
    { polaco: 'maj', pronunciacion: 'may', traduccion: 'mayo', ejemplo: 'Maj jest pieknym miesiacem.' },
    { polaco: 'czerwiec', pronunciacion: 'CHER-vyets', traduccion: 'junio', ejemplo: 'Lato zaczyna sie w czerwcu.' },
    { polaco: 'lipiec', pronunciacion: 'LI-pyets', traduccion: 'julio', ejemplo: 'Lipiec jest najcieplejszym miesiacem.' },
    { polaco: 'sierpien', pronunciacion: 'SHER-pyen', traduccion: 'agosto', ejemplo: 'W sierpniu jedziemy na wakacje.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice enero en polaco?', opciones: ['luty', 'styczen', 'marzec', 'kwiecien'], correcta: 'styczen' },
    { pregunta: 'Que significa maj?', opciones: ['marzo', 'abril', 'mayo', 'junio'], correcta: 'mayo' },
    { pregunta: 'Como se dice julio en polaco?', opciones: ['czerwiec', 'sierpien', 'lipiec', 'maj'], correcta: 'lipiec' },
    { pregunta: 'Que significa luty?', opciones: ['enero', 'febrero', 'marzo', 'abril'], correcta: 'febrero' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 42 · Modulo 5</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Los meses del ano parte 1</h1>
          <p className="text-gray-500 mt-2">Aprende los meses de enero a agosto en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-43" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
