...
export default function Leccion88() {
  ...
  const vocabulario = [
    { polaco: 'Mysle ze', pronunciacion: 'MISH-le zhe', traduccion: 'Creo que pienso que', ejemplo: 'Mysle ze to dobry pomysl.' },
    { polaco: 'Moim zdaniem', pronunciacion: 'MO-im ZDA-nyem', traduccion: 'En mi opinion', ejemplo: 'Moim zdaniem to za drogo.' },
    { polaco: 'Zgadzam sie', pronunciacion: 'zga-DZAM she', traduccion: 'Estoy de acuerdo', ejemplo: 'Zgadzam sie z toba w tej kwestii.' },
    { polaco: 'Nie zgadzam sie', pronunciacion: 'nye zga-DZAM she', traduccion: 'No estoy de acuerdo', ejemplo: 'Przepraszam, ale nie zgadzam sie.' },
    { polaco: 'Masz racje', pronunciacion: 'mash RA-tsye', traduccion: 'Tienes razon', ejemplo: 'Masz racje, to byl blad.' },
    { polaco: 'Nie masz racji', pronunciacion: 'nye mash RA-tsyi', traduccion: 'No tienes razon', ejemplo: 'Przepraszam, ale nie masz racji.' },
    { polaco: 'To ciekawe', pronunciacion: 'to CHE-ka-ve', traduccion: 'Eso es interesante', ejemplo: 'To ciekawe, nie wiedzialem o tym.' },
    { polaco: 'Nie jestem pewien', pronunciacion: 'nye YES-tem PE-vyen', traduccion: 'No estoy seguro', ejemplo: 'Nie jestem pewien czy to dobry pomysl.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice estoy de acuerdo en polaco?', opciones: ['Nie zgadzam sie', 'Zgadzam sie', 'Masz racje', 'Mysle ze'], correcta: 'Zgadzam sie' },
    { pregunta: 'Que significa Moim zdaniem?', opciones: ['Creo que', 'Tienes razon', 'En mi opinion', 'No estoy seguro'], correcta: 'En mi opinion' },
    { pregunta: 'Como se dice tienes razon en polaco?', opciones: ['Zgadzam sie', 'To ciekawe', 'Masz racje', 'Mysle ze'], correcta: 'Masz racje' },
    { pregunta: 'Que significa To ciekawe?', opciones: ['Eso es aburrido', 'No estoy seguro', 'Eso es interesante', 'Tienes razon'], correcta: 'Eso es interesante' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 88 · Modulo 9</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Dar y recibir opiniones</h1>
          <p className="text-gray-500 mt-2">Aprende a expresar y debatir opiniones en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-89" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
