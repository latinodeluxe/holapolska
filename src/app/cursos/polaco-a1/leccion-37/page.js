...
export default function Leccion37() {
  ...
  const vocabulario = [
    { polaco: 'kilogram', pronunciacion: 'KI-lo-gram', traduccion: 'kilogramo', ejemplo: 'Prosze kilogram pomidorow.' },
    { polaco: 'pol kilograma', pronunciacion: 'puw ki-LO-gra-ma', traduccion: 'medio kilo', ejemplo: 'Pol kilograma masla prosze.' },
    { polaco: 'litr', pronunciacion: 'litr', traduccion: 'litro', ejemplo: 'Litr mleka prosze.' },
    { polaco: 'sztuka', pronunciacion: 'SHTU-ka', traduccion: 'unidad pieza', ejemplo: 'Trzy sztuki jablek prosze.' },
    { polaco: 'zloty', pronunciacion: 'ZWO-ti', traduccion: 'zloty moneda polaca', ejemplo: 'To kosztuje dziesiec zlotych.' },
    { polaco: 'grosz', pronunciacion: 'grosh', traduccion: 'centavo grosz', ejemplo: 'Piecdziesiat groszy reszty.' },
    { polaco: 'drogi', pronunciacion: 'DRO-gi', traduccion: 'caro', ejemplo: 'Ten produkt jest za drogi.' },
    { polaco: 'tani', pronunciacion: 'TA-ni', traduccion: 'barato', ejemplo: 'To jest bardzo tanie.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice kilogramo en polaco?', opciones: ['litr', 'sztuka', 'kilogram', 'grosz'], correcta: 'kilogram' },
    { pregunta: 'Que significa zloty?', opciones: ['centavo', 'zloty moneda polaca', 'caro', 'barato'], correcta: 'zloty moneda polaca' },
    { pregunta: 'Como se dice barato en polaco?', opciones: ['drogi', 'tani', 'sztuka', 'litr'], correcta: 'tani' },
    { pregunta: 'Que significa sztuka?', opciones: ['kilogramo', 'litro', 'unidad pieza', 'medio kilo'], correcta: 'unidad pieza' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 37 · Modulo 4</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Cantidades y precios</h1>
          <p className="text-gray-500 mt-2">Aprende a hablar de cantidades y precios en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-38" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
