...
export default function Leccion14() {
  ...
  const vocabulario = [
    { polaco: 'Polska', pronunciacion: 'POL-ska', traduccion: 'Polonia', ejemplo: 'Polska jest pieknym krajem.' },
    { polaco: 'Hiszpania', pronunciacion: 'hish-PA-nya', traduccion: 'Espana', ejemplo: 'Mieszkam w Hiszpanii.' },
    { polaco: 'Meksyk', pronunciacion: 'MEK-sik', traduccion: 'Mexico', ejemplo: 'Jestem z Meksyku.' },
    { polaco: 'Niemcy', pronunciacion: 'NYEM-tsi', traduccion: 'Alemania', ejemplo: 'On studiuje w Niemczech.' },
    { polaco: 'Francja', pronunciacion: 'FRAN-tsya', traduccion: 'Francia', ejemplo: 'Paryz jest w Francji.' },
    { polaco: 'Wlochy', pronunciacion: 'VWO-hi', traduccion: 'Italia', ejemplo: 'Pizza pochodzi z Wloch.' },
    { polaco: 'kraj', pronunciacion: 'kray', traduccion: 'pais', ejemplo: 'Jaki kraj lubisz najbardziej?' },
    { polaco: 'miasto', pronunciacion: 'MYAS-to', traduccion: 'ciudad', ejemplo: 'Warszawa to piekne miasto.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice Alemania en polaco?', opciones: ['Francja', 'Wlochy', 'Niemcy', 'Polska'], correcta: 'Niemcy' },
    { pregunta: 'Que significa kraj?', opciones: ['ciudad', 'pais', 'capital', 'region'], correcta: 'pais' },
    { pregunta: 'Como se dice Francia en polaco?', opciones: ['Wlochy', 'Francja', 'Niemcy', 'Hiszpania'], correcta: 'Francja' },
    { pregunta: 'Que significa miasto?', opciones: ['pais', 'pueblo', 'ciudad', 'capital'], correcta: 'ciudad' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 14 · Modulo 2</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">Paises y nacionalidades</h1>
          <p className="text-gray-500 mt-2">Aprende los paises mas importantes en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-15" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
