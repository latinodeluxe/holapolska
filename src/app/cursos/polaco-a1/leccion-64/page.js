...
export default function Leccion64() {
  ...
  const vocabulario = [
    { polaco: 'apteka', pronunciacion: 'ap-TE-ka', traduccion: 'farmacia', ejemplo: 'Apteka jest czynna calą dobe.' },
    { polaco: 'lek', pronunciacion: 'lek', traduccion: 'medicamento', ejemplo: 'Biore lek trzy razy dziennie.' },
    { polaco: 'tabletka', pronunciacion: 'tab-LET-ka', traduccion: 'pastilla tableta', ejemplo: 'Prosze tabletki na bol glowy.' },
    { polaco: 'syrop', pronunciacion: 'SI-rop', traduccion: 'jarabe', ejemplo: 'Syrop na kaszel dla dziecka.' },
    { polaco: 'masc', pronunciacion: 'mashch', traduccion: 'crema pomada', ejemplo: 'Masc na wysypke skorna.' },
    { polaco: 'na recepte', pronunciacion: 'na re-TSEP-te', traduccion: 'con receta', ejemplo: 'Ten lek jest tylko na recepte.' },
    { polaco: 'bez recepty', pronunciacion: 'bez re-TSEP-ti', traduccion: 'sin receta', ejemplo: 'Aspiryna jest bez recepty.' },
    { polaco: 'dawka', pronunciacion: 'DAV-ka', traduccion: 'dosis', ejemplo: 'Jaka jest zalecana dawka?' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice farmacia en polaco?', opciones: ['lek', 'tabletka', 'apteka', 'syrop'], correcta: 'apteka' },
    { pregunta: 'Que significa tabletka?', opciones: ['jarabe', 'crema', 'pastilla tableta', 'dosis'], correcta: 'pastilla tableta' },
    { pregunta: 'Como se dice sin receta en polaco?', opciones: ['na recepte', 'bez recepty', 'dawka', 'lek'], correcta: 'bez recepty' },
    { pregunta: 'Que significa dawka?', opciones: ['pastilla', 'jarabe', 'receta', 'dosis'], correcta: 'dosis' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 64 · Modulo 7</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">En la farmacia</h1>
          <p className="text-gray-500 mt-2">Aprende a comprar medicamentos en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-65" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
