...
export default function Leccion74() {
  ...
  const vocabulario = [
    { polaco: 'komputer', pronunciacion: 'kom-PU-ter', traduccion: 'computadora', ejemplo: 'Pracuje na komputerze caly dzien.' },
    { polaco: 'drukarka', pronunciacion: 'dru-KAR-ka', traduccion: 'impresora', ejemplo: 'Drukarka jest zepsuta.' },
    { polaco: 'mail', pronunciacion: 'meyl', traduccion: 'correo electronico', ejemplo: 'Wyslalem maila do klienta.' },
    { polaco: 'telefon sluzbowy', pronunciacion: 'te-LE-fon SWUZH-bo-vi', traduccion: 'telefono de trabajo', ejemplo: 'Mam telefon sluzbowy od firmy.' },
    { polaco: 'sala konferencyjna', pronunciacion: 'SA-la kon-fe-ren-TSIY-na', traduccion: 'sala de conferencias', ejemplo: 'Spotkanie jest w sali konferencyjnej.' },
    { polaco: 'prezentacja', pronunciacion: 'pre-zen-TA-tsya', traduccion: 'presentacion', ejemplo: 'Przygotowuje prezentacje na jutro.' },
    { polaco: 'raport', pronunciacion: 'RA-port', traduccion: 'informe reporte', ejemplo: 'Musze napisac raport do piatku.' },
    { polaco: 'deadline', pronunciacion: 'DED-layn', traduccion: 'fecha limite plazo final', ejemplo: 'Deadline jest jutro o polnocy.' },
  ]
  const ejercicios = [
    { pregunta: 'Como se dice impresora en polaco?', opciones: ['komputer', 'drukarka', 'mail', 'raport'], correcta: 'drukarka' },
    { pregunta: 'Que significa prezentacja?', opciones: ['informe', 'sala', 'presentacion', 'plazo'], correcta: 'presentacion' },
    { pregunta: 'Como se dice informe en polaco?', opciones: ['deadline', 'raport', 'mail', 'komputer'], correcta: 'raport' },
    { pregunta: 'Que significa sala konferencyjna?', opciones: ['oficina', 'sala de conferencias', 'sala de espera', 'recepcion'], correcta: 'sala de conferencias' },
  ]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <span className="text-sm text-red-500 font-medium">Leccion 74 · Modulo 8</span>
          <h1 className="text-3xl font-bold text-gray-900 mt-1">En la oficina</h1>
          <p className="text-gray-500 mt-2">Aprende vocabulario de oficina en polaco</p>
        </div>
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center mt-8">
                  ...
                  <a href="/cursos/polaco-a1/leccion-75" className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
