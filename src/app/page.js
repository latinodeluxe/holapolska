    ...
    <main className="min-h-screen bg-cream font-sans">
      ...
      <nav className="bg-cream border-b border-navy/8 px-8 py-4 flex justify-between items-center sticky top-0 z-50">
        ...
        <div className="flex items-center gap-6">
          ...
          <a href="/idioma/registro" className="bg-magenta text-white text-sm font-semibold px-5 py-2.5 rounded-full hover:bg-magenta/90 transition-colors">Empezar gratis</a>
        </div>
      </nav>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-end">
          <div className="pb-12">
            ...
            <p className="text-base text-white/50 leading-relaxed mb-8 max-w-md">
              Idioma, tramites, cultura y comunidad — sin costo, sin barreras, hecho por y para la comunidad latina en Polonia.
            </p>
            <div className="flex gap-3 flex-wrap">
              <a href="/idioma/registro" className="bg-magenta text-white text-sm font-bold px-7 py-3.5 rounded-full hover:bg-magenta/90 transition-colors">Empezar gratis</a>
              <a href="/idioma" className="border border-white/20 text-white/70 text-sm px-6 py-3.5 rounded-full hover:border-white/40 transition-colors">Ver el curso de polaco</a>
            </div>
          </div>
          ...
          <div className="pb-0">
            <div className="bg-white/5 rounded-t-2xl border border-white/10 border-b-0 p-6">
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-xs text-white/30">35 / 100 lecciones</span>
              </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex items-end justify-between mb-8">
            <div>
              ...
              <h2 className="font-display text-2xl font-bold text-navy tracking-tight">Todo lo que necesitas en un solo lugar</h2>
            </div>
            <a href="/idioma" className="text-sm text-magenta font-semibold hidden sm:block hover:underline">Ver todos →</a>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            <a href="/idioma" className="bg-magenta rounded-2xl p-6 flex flex-col justify-between lg:row-span-2 hover:bg-magenta/90 transition-colors group">
              <div>
                <div className="w-14 h-14 rounded-2xl bg-white/15 flex items-center justify-center text-3xl mb-5">🇵🇱</div>
                <div className="text-xl font-bold text-white mb-2">Aprender polaco</div>
                <div className="text-sm text-white/60 leading-relaxed">Curso A1 completo con vocabulario, flashcards y ejercicios interactivos. Sistema de XP y rachas para mantenerte motivado.</div>
              </div>
              <div className="mt-6">
                <span className="bg-white/20 text-white text-xs font-bold px-4 py-1.5 rounded-full">100 lecciones gratis</span>
              </div>
            </a>
            ...
            {modulos.map((m) => {
              ...
              return (
                <a key={m.titulo} href={m.href} className={`${c.bg} rounded-2xl p-5 flex items-center gap-4 hover:opacity-90 transition-opacity`}>
                  <div className={`${c.icon} w-12 h-12 rounded-xl flex items-center justify-center text-xl flex-shrink-0`}>{m.icono}</div>
                  <div>
                    <div className="text-base font-semibold text-navy">{m.titulo}</div>
                    <div className={`text-sm mt-0.5 ${c.text}`}>{m.desc}</div>
                  </div>
                </a>
              )
            })}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex items-end justify-between mb-8">
            <div>
              ...
              <h2 className="font-display text-2xl font-bold text-navy tracking-tight">Negocios que apoyan a la comunidad</h2>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
            {negocios.map((n) => {
              ...
              return (
                <div key={n.nombre} className="bg-white rounded-2xl p-5 border border-navy/8 flex items-center gap-4">
            ...
            <a href={WA_LINK} target="_blank" rel="noopener noreferrer"
              ...
              <div>
                <div className="text-sm font-bold text-navy">Tu negocio aqui</div>
          ...
          <div className="bg-navy rounded-2xl p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              ...
              <div className="text-sm text-white/40">Aparecer aqui es gratis durante el lanzamiento. Contactanos por WhatsApp.</div>
            </div>
            <a href={WA_LINK} target="_blank" rel="noopener noreferrer"
      ...
      <section className="bg-magenta px-8 py-10">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          <div>
            <div className="text-2xl font-display font-extrabold text-white mb-2">Empieza hoy, es gratis.</div>
            <div className="text-sm text-white/65">Sin tarjeta, sin suscripcion, sin tramites.</div>
          </div>
          <a href="/idioma/registro" className="bg-white text-magenta text-sm font-bold px-7 py-3.5 rounded-full whitespace-nowrap hover:bg-white/90 transition-colors">Crear cuenta gratis</a>
        </div>
      </section>
