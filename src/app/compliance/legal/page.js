export default function LegalPage() {
  return (
    <main style={{ padding: '2rem', maxWidth: '800px', margin: '0 auto', fontFamily: 'sans-serif' }}>
      ...
      <section style={{ marginBottom: '1.5rem' }}>
        <h2>2. Identificación de la Actividad</h2>
        <p>Esta plataforma tiene como objetivo facilitar la integración social, cultural y lingüística de la comunidad hispanohablante en Polonia. Todos los servicios prestados se realizan bajo el marco legal de la Unión Europea y la legislación local polaca.</p>
      </section>
