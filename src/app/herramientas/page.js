export const metadata = {
  ...
  description: 'Conversor de PLN, frases utiles en polaco, numeros de emergencia y mas herramientas practicas para el dia a dia en Polonia.',
}
...
const temas = [
  ...
  { titulo: 'Numeros de emergencia', desc: 'Los numeros que debes tener guardados', icono: '🚨', href: '/herramientas/numeros-emergencia', disponible: true },
  { titulo: 'Traductor de documentos', desc: 'Guia para traducir documentos oficiales', icono: '📄', href: '#', disponible: false },
  { titulo: 'Buscador de oficinas', desc: 'Encuentra el Urzad o banco mas cercano', icono: '📍', href: '#', disponible: false },
    ...
    <div className="min-h-screen bg-cream flex flex-col font-sans">
      ...
      <div className="max-w-6xl mx-auto px-8 py-12 flex-1 w-full">
        <div className="mb-10">
          ...
          <p className="text-navy/50 text-base max-w-xl">Recursos practicos para tu dia a dia en Polonia: conversores, frases, numeros utiles y mas.</p>
        </div>
